...
/****** Object:  StoredProcedure [dbo].[PR_PREVISAO_ORCAMENTARIA_MUNICIPAL]    Script Date: 24/10/2018 18:28:22 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [dbo].[PR_PREVISAO_ORCAMENTARIA_MUNICIPAL]
@ID_PREFEITURA  INT 
AS
...
LEFT JOIN (
	SELECT T.ID_TIPO_PROTECAO,
	 P.NOME AS PROTECAO_SOCIAL, 
	 SUM(VALOR_MUNICIPAL_ASSISTENCIA) AS REDE_PUBLICA_MUNICIPAL, 
	 SUM(VALOR_ESTADUAL_ASSISTENCIA + VALOR_ESTADUAL_FEDCA + VALOR_ESTADUAL_FEI) AS REDE_PUBLICA_ESTADUAL,
	 SUM(VALOR_FEDERAL_ASSISTENCIA + VALOR_FEDERAL_FNDCA + VALOR_FEDERAL_FNI) AS REDE_PUBLICA_FEDERAL,
	 --SUM(VALOR_ESTADUALIZADO) AS REDE_PUBLICA_ESTADUALIZADO,
	 ...
	 SUM(VALOR_MUNICIPAL_ASSISTENCIA) AS REDE_PRIVADA_MUNICIPAL, 
	 SUM(VALOR_ESTADUAL_ASSISTENCIA + VALOR_ESTADUAL_FEDCA + VALOR_ESTADUAL_FEI) AS REDE_PRIVADA_ESTADUAL,	 
	 SUM(VALOR_FEDERAL_ASSISTENCIA + VALOR_FEDERAL_FNDCA + VALOR_FEDERAL_FNI) AS REDE_PRIVADA_FEDERAL,	 
	 SUM(VALOR_RECURSO_EXCLUSIVO_SERVICO) AS PRIVADO,
	 SUM(VALOR_ESTADUALIZADO) AS REDE_PRIVADA_ESTADUALIZADO
