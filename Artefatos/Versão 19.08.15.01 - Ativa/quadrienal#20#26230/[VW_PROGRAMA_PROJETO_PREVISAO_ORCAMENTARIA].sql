...
/****** Object:  View [dbo].[VW_PROGRAMA_PROJETO_PREVISAO_ORCAMENTARIA]    Script Date: 12/09/2019 15:42:52 ******/
SET ANSI_NULLS ON
GO
...
ALTER VIEW [dbo].[VW_PROGRAMA_PROJETO_PREVISAO_ORCAMENTARIA]
AS
  ...
  SELECT 
		...
		,CASE ((SELECT COUNT(A.ID)  
			...
			P.ATIVO
			--,  CASE WHEN P2.EXERCICIO IS NULL THEN 2018 ELSE P2.EXERCICIO END AS EXERCICIO
	...
	LEFT JOIN TB_PROGRAMA_PROJETO_RECURSOS_FINANCEIROS P2 ON(P2.ID_PROGRAMA_PROJETO = P.ID)
