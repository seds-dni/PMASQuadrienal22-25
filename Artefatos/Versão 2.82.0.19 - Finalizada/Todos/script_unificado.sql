...
--#		GRANT
--###############################################################
GRANT EXEC on [dbo].[PR_BLOQUEIO_DESBLOQUEIO_GERAL] TO USERPMAS2009
GRANT EXEC on [dbo].[PR_BLOQUEIO_DESBLOQUEIO_GERAL] TO SAPROSOCIAL
GRANT EXEC on [dbo].[PR_BLOQUEIO_DESBLOQUEIO_GERAL] TO USERPROSOCIAL
GRANT EXEC on [dbo].[PR_BLOQUEIO_DESBLOQUEIO_GERAL] TO usupmasreporting
GO
--###############################################################
--#		GRANT
--###############################################################
GRANT EXEC on [dbo].[PR_SITUACAO_BLOQUEIO_QUADROS_LO_EF] TO USERPMAS2009
GRANT EXEC on [dbo].[PR_SITUACAO_BLOQUEIO_QUADROS_LO_EF] TO SAPROSOCIAL
GRANT EXEC on [dbo].[PR_SITUACAO_BLOQUEIO_QUADROS_LO_EF] TO USERPROSOCIAL
GRANT EXEC on [dbo].[PR_SITUACAO_BLOQUEIO_QUADROS_LO_EF] TO usupmasreporting
GO