...
{
    public partial class VServicoRecursoFinanceiroPrivado : System.Web.UI.Page
    {
        private List<int> PrivadoExercicios = new List<int> { 2022, 2023, 2024, 2025 };
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                {
                    Response.Redirect("~/BlocoII/CUnidadesPrivadas.aspx");
                    return;
                }
        ...
        void load(ProxyRedeProtecaoSocial proxy, ProxyEstruturaAssistenciaSocial proxyEstrutura, ProxyProgramas proxyProgramas)
        {
            ...
            var servico = proxy.Service.GetServicoRecursoFinanceiroPrivadoById(idServico);
            if (servico == null)
                return;
            ...
            lblTipoProtecao.Text = servico.UsuarioTipoServico.TipoServico.IdTipoProtecaoSocial == 1
                ? "Básica"
                : servico.UsuarioTipoServico.TipoServico.IdTipoProtecaoSocial == 2
                ? "Média Complexidade"
                : "Alta Complexidade";

            #region servico tipificado
            if (servico.IdTipoServicoNaoTipificado != null || servico.UsuarioTipoServico.IdTipoServico == 153)
            {
                if (servico.UsuarioTipoServico.TipoServico.IdTipoProtecaoSocial != 3)
                {
                    lblTipoServico.Text += "Serviço não tipificado pela Resolução n° 109 do CNAS, de 11/11/2009 - " + servico.UsuarioTipoServico.TipoServico.Nome;
            ...
            if (idAbrangencias == 4)
            {
                ...
                else if (servico.IdFormaJuridica != 0 && servico.IdFormaJuridica != null)
                {
                    lblJuridica.Text = juridica.First(a => a.Id == servico.IdFormaJuridica).NomeForma;
                    trTituloFormaJuridica.Visible = true;
            ...
            switch (servico.IdCaracteristicasTerritorio)
            {
                ...
                case 14: lblCaracteristicasTerritorio.Text = "Nenhuma das alternativas anteriores"; break;// "Nenhuma das condições socioterritoriais"; break;
            ...
            #region Capacidade
            var servicosRecursosFinanceiroPrivadoCapacidadeExercicio1 = servico.ServicosRecursosFinanceiroPrivadoCapacidade.Where(x => x.Exercicio == this.PrivadoExercicios[0]).FirstOrDefault();
            var servicosRecursosFinanceiroPrivadoCapacidadeLAExercicio1 = servico.ServicosRecursosFinanceiroPrivadoCapacidadeLA.Where(x => x.Exercicio == this.PrivadoExercicios[0]).FirstOrDefault();
            var servicosRecursosFinanceiroPrivadoCapacidadePSCExercicio1 = servico.ServicosRecursosFinanceiroPrivadoCapacidadePSC.Where(x => x.Exercicio == this.PrivadoExercicios[0]).FirstOrDefault();

            var servicosRecursosFinanceiroPrivadoCapacidadeExercicio2 = servico.ServicosRecursosFinanceiroPrivadoCapacidade.Where(x => x.Exercicio == this.PrivadoExercicios[1]).FirstOrDefault();
            var servicosRecursosFinanceiroPrivadoCapacidadeLAExercicio2 = servico.ServicosRecursosFinanceiroPrivadoCapacidadeLA.Where(x => x.Exercicio == this.PrivadoExercicios[1]).FirstOrDefault();
            var servicosRecursosFinanceiroPrivadoCapacidadePSCExercicio2 = servico.ServicosRecursosFinanceiroPrivadoCapacidadePSC.Where(x => x.Exercicio == this.PrivadoExercicios[1]).FirstOrDefault();

            var servicosRecursosFinanceiroPrivadoCapacidadeExercicio3 = servico.ServicosRecursosFinanceiroPrivadoCapacidade.Where(x => x.Exercicio == this.PrivadoExercicios[2]).FirstOrDefault();
            var servicosRecursosFinanceiroPrivadoCapacidadeLAExercicio3 = servico.ServicosRecursosFinanceiroPrivadoCapacidadeLA.Where(x => x.Exercicio == this.PrivadoExercicios[2]).FirstOrDefault();
            var servicosRecursosFinanceiroPrivadoCapacidadePSCExercicio3 = servico.ServicosRecursosFinanceiroPrivadoCapacidadePSC.Where(x => x.Exercicio == this.PrivadoExercicios[2]).FirstOrDefault();

            var servicosRecursosFinanceiroPrivadoCapacidadeExercicio4 = servico.ServicosRecursosFinanceiroPrivadoCapacidade.Where(x => x.Exercicio == this.PrivadoExercicios[3]).FirstOrDefault();
            var servicosRecursosFinanceiroPrivadoCapacidadeLAExercicio4 = servico.ServicosRecursosFinanceiroPrivadoCapacidadeLA.Where(x => x.Exercicio == this.PrivadoExercicios[3]).FirstOrDefault();
            var servicosRecursosFinanceiroPrivadoCapacidadePSCExercicio4 = servico.ServicosRecursosFinanceiroPrivadoCapacidadePSC.Where(x => x.Exercicio == this.PrivadoExercicios[3]).FirstOrDefault();
            #endregion

            #region Media Mensal
            var servicosRecursosFinanceiroPrivadoMediaMensalExercicio1 = servico.ServicosRecursosFinanceiroPrivadoMediaMensal.Where(x => x.Exercicio == this.PrivadoExercicios[0]).FirstOrDefault();
            var servicosRecursosFinanceiroPrivadoMediaMensalLAExercicio1 = servico.ServicosRecursosFinanceiroPrivadoMediaMensalLA.Where(x => x.Exercicio == this.PrivadoExercicios[0]).FirstOrDefault();
            var servicosRecursosFinanceiroPrivadoMediaMensalPSCExercicio1 = servico.ServicosRecursosFinanceiroPrivadoMediaMensalPSC.Where(x => x.Exercicio == this.PrivadoExercicios[0]).FirstOrDefault();

            var servicosRecursosFinanceiroPrivadoMediaMensalExercicio2 = servico.ServicosRecursosFinanceiroPrivadoMediaMensal.Where(x => x.Exercicio == this.PrivadoExercicios[1]).FirstOrDefault();
            var servicosRecursosFinanceiroPrivadoMediaMensalLAExercicio2 = servico.ServicosRecursosFinanceiroPrivadoMediaMensalLA.Where(x => x.Exercicio == this.PrivadoExercicios[1]).FirstOrDefault();
            var servicosRecursosFinanceiroPrivadoMediaMensalPSCExercicio2 = servico.ServicosRecursosFinanceiroPrivadoMediaMensalPSC.Where(x => x.Exercicio == this.PrivadoExercicios[1]).FirstOrDefault();

            var servicosRecursosFinanceiroPrivadoMediaMensalExercicio3 = servico.ServicosRecursosFinanceiroPrivadoMediaMensal.Where(x => x.Exercicio == this.PrivadoExercicios[2]).FirstOrDefault();
            var servicosRecursosFinanceiroPrivadoMediaMensalLAExercicio3 = servico.ServicosRecursosFinanceiroPrivadoMediaMensalLA.Where(x => x.Exercicio == this.PrivadoExercicios[2]).FirstOrDefault();
            var servicosRecursosFinanceiroPrivadoMediaMensalPSCExercicio3 = servico.ServicosRecursosFinanceiroPrivadoMediaMensalPSC.Where(x => x.Exercicio == this.PrivadoExercicios[2]).FirstOrDefault();

            var servicosRecursosFinanceiroPrivadoMediaMensalExercicio4 = servico.ServicosRecursosFinanceiroPrivadoMediaMensal.Where(x => x.Exercicio == this.PrivadoExercicios[3]).FirstOrDefault();
            var servicosRecursosFinanceiroPrivadoMediaMensalLAExercicio4 = servico.ServicosRecursosFinanceiroPrivadoMediaMensalLA.Where(x => x.Exercicio == this.PrivadoExercicios[3]).FirstOrDefault();
            var servicosRecursosFinanceiroPrivadoMediaMensalPSCExercicio4 = servico.ServicosRecursosFinanceiroPrivadoMediaMensalPSC.Where(x => x.Exercicio == this.PrivadoExercicios[3]).FirstOrDefault();
            #endregion
            ...
            if (servico.UsuarioTipoServico.TipoServico.Id == R_TIPO_SERVICO.SERVICO_PROTECAO_SOCIAL_ADOLESC_CUMPR_MEDIDA_SOCIOEDUCATIVA_LA_PSC)
            {
                ...
                lblCapacidadeLAExercicio1.Text = servicosRecursosFinanceiroPrivadoCapacidadeLAExercicio1 != null ? servicosRecursosFinanceiroPrivadoCapacidadeLAExercicio1.Capacidade != null ? servicosRecursosFinanceiroPrivadoCapacidadeLAExercicio1.Capacidade.Value.ToString() : "0" : "0";
                lblCapacidadeLAExercicio2.Text = servicosRecursosFinanceiroPrivadoCapacidadeLAExercicio2 != null ? servicosRecursosFinanceiroPrivadoCapacidadeLAExercicio2.Capacidade != null ? servicosRecursosFinanceiroPrivadoCapacidadeLAExercicio2.Capacidade.Value.ToString() : "0" : "0";
                lblCapacidadeLAExercicio3.Text = servicosRecursosFinanceiroPrivadoCapacidadeLAExercicio3 != null ? servicosRecursosFinanceiroPrivadoCapacidadeLAExercicio3.Capacidade != null ? servicosRecursosFinanceiroPrivadoCapacidadeLAExercicio3.Capacidade.Value.ToString() : "0" : "0";
                lblCapacidadeLAExercicio4.Text = servicosRecursosFinanceiroPrivadoCapacidadeLAExercicio4 != null ? servicosRecursosFinanceiroPrivadoCapacidadeLAExercicio4.Capacidade != null ? servicosRecursosFinanceiroPrivadoCapacidadeLAExercicio4.Capacidade.Value.ToString() : "0" : "0";

                lblCapacidadePSCExercicio1.Text = servicosRecursosFinanceiroPrivadoCapacidadePSCExercicio1 != null ? servicosRecursosFinanceiroPrivadoCapacidadePSCExercicio1.Capacidade != null ? servicosRecursosFinanceiroPrivadoCapacidadePSCExercicio1.Capacidade.Value.ToString() : "0" : "0";
                lblCapacidadePSCExercicio2.Text = servicosRecursosFinanceiroPrivadoCapacidadePSCExercicio2 != null ? servicosRecursosFinanceiroPrivadoCapacidadePSCExercicio2.Capacidade != null ? servicosRecursosFinanceiroPrivadoCapacidadePSCExercicio2.Capacidade.Value.ToString() : "0" : "0";
                lblCapacidadePSCExercicio3.Text = servicosRecursosFinanceiroPrivadoCapacidadePSCExercicio3 != null ? servicosRecursosFinanceiroPrivadoCapacidadePSCExercicio3.Capacidade != null ? servicosRecursosFinanceiroPrivadoCapacidadePSCExercicio3.Capacidade.Value.ToString() : "0" : "0";
                lblCapacidadePSCExercicio4.Text = servicosRecursosFinanceiroPrivadoCapacidadePSCExercicio4 != null ? servicosRecursosFinanceiroPrivadoCapacidadePSCExercicio4.Capacidade != null ? servicosRecursosFinanceiroPrivadoCapacidadePSCExercicio4.Capacidade.Value.ToString() : "0" : "0";
                #endregion

                #region Media Mensal [LA]
                lblMediaMensalLAExercicio1.Text = servicosRecursosFinanceiroPrivadoMediaMensalLAExercicio1 != null ? servicosRecursosFinanceiroPrivadoMediaMensalLAExercicio1.MediaMensal != null ? servicosRecursosFinanceiroPrivadoMediaMensalLAExercicio1.MediaMensal.Value.ToString() : "0" : "0";
                lblMediaMensalLAExercicio2.Text = servicosRecursosFinanceiroPrivadoMediaMensalLAExercicio2 != null ? servicosRecursosFinanceiroPrivadoMediaMensalLAExercicio2.MediaMensal != null ? servicosRecursosFinanceiroPrivadoMediaMensalLAExercicio2.MediaMensal.Value.ToString() : "0" : "0";
                lblMediaMensalLAExercicio3.Text = servicosRecursosFinanceiroPrivadoMediaMensalLAExercicio3 != null ? servicosRecursosFinanceiroPrivadoMediaMensalLAExercicio3.MediaMensal != null ? servicosRecursosFinanceiroPrivadoMediaMensalLAExercicio3.MediaMensal.Value.ToString() : "0" : "0";
                lblMediaMensalLAExercicio4.Text = servicosRecursosFinanceiroPrivadoMediaMensalLAExercicio4 != null ? servicosRecursosFinanceiroPrivadoMediaMensalLAExercicio4.MediaMensal != null ? servicosRecursosFinanceiroPrivadoMediaMensalLAExercicio4.MediaMensal.Value.ToString() : "0" : "0";

                lblMediaMensalPSCExercicio1.Text = servicosRecursosFinanceiroPrivadoMediaMensalPSCExercicio1 != null ? servicosRecursosFinanceiroPrivadoMediaMensalPSCExercicio1.MediaMensal != null ? servicosRecursosFinanceiroPrivadoMediaMensalPSCExercicio1.MediaMensal.Value.ToString() : "0" : "0";
                lblMediaMensalPSCExercicio2.Text = servicosRecursosFinanceiroPrivadoMediaMensalPSCExercicio2 != null ? servicosRecursosFinanceiroPrivadoMediaMensalPSCExercicio2.MediaMensal != null ? servicosRecursosFinanceiroPrivadoMediaMensalPSCExercicio2.MediaMensal.Value.ToString() : "0" : "0";
                lblMediaMensalPSCExercicio3.Text = servicosRecursosFinanceiroPrivadoMediaMensalPSCExercicio3 != null ? servicosRecursosFinanceiroPrivadoMediaMensalPSCExercicio3.MediaMensal != null ? servicosRecursosFinanceiroPrivadoMediaMensalPSCExercicio3.MediaMensal.Value.ToString() : "0" : "0";
                lblMediaMensalPSCExercicio4.Text = servicosRecursosFinanceiroPrivadoMediaMensalPSCExercicio4 != null ? servicosRecursosFinanceiroPrivadoMediaMensalPSCExercicio4.MediaMensal != null ? servicosRecursosFinanceiroPrivadoMediaMensalPSCExercicio4.MediaMensal.Value.ToString() : "0" : "0";
                #endregion
            }
            else
            {
                ...
                #region Capacidade [LA]
                lblCapacidadeExercicio1.Text = servicosRecursosFinanceiroPrivadoCapacidadeExercicio1 != null ? servicosRecursosFinanceiroPrivadoCapacidadeExercicio1.Capacidade != null ? servicosRecursosFinanceiroPrivadoCapacidadeExercicio1.Capacidade.Value.ToString() : "0" : "0";
                lblCapacidadeExercicio2.Text = servicosRecursosFinanceiroPrivadoCapacidadeExercicio2 != null ? servicosRecursosFinanceiroPrivadoCapacidadeExercicio2.Capacidade != null ? servicosRecursosFinanceiroPrivadoCapacidadeExercicio2.Capacidade.Value.ToString() : "0" : "0";
                lblCapacidadeExercicio3.Text = servicosRecursosFinanceiroPrivadoCapacidadeExercicio3 != null ? servicosRecursosFinanceiroPrivadoCapacidadeExercicio3.Capacidade != null ? servicosRecursosFinanceiroPrivadoCapacidadeExercicio3.Capacidade.Value.ToString() : "0" : "0";
                lblCapacidadeExercicio4.Text = servicosRecursosFinanceiroPrivadoCapacidadeExercicio4 != null ? servicosRecursosFinanceiroPrivadoCapacidadeExercicio4.Capacidade != null ? servicosRecursosFinanceiroPrivadoCapacidadeExercicio4.Capacidade.Value.ToString() : "0" : "0";
                #endregion

                #region Media Mensal [LA]
                lblMediaMensalExercicio1.Text = servicosRecursosFinanceiroPrivadoMediaMensalExercicio1 != null ? servicosRecursosFinanceiroPrivadoMediaMensalExercicio1.MediaMensal != null ? servicosRecursosFinanceiroPrivadoMediaMensalExercicio1.MediaMensal.Value.ToString() : "0" : "0";
                lblMediaMensalExercicio2.Text = servicosRecursosFinanceiroPrivadoMediaMensalExercicio2 != null ? servicosRecursosFinanceiroPrivadoMediaMensalExercicio2.MediaMensal != null ? servicosRecursosFinanceiroPrivadoMediaMensalExercicio2.MediaMensal.Value.ToString() : "0" : "0";
                lblMediaMensalExercicio3.Text = servicosRecursosFinanceiroPrivadoMediaMensalExercicio3 != null ? servicosRecursosFinanceiroPrivadoMediaMensalExercicio3.MediaMensal != null ? servicosRecursosFinanceiroPrivadoMediaMensalExercicio3.MediaMensal.Value.ToString() : "0" : "0";
                lblMediaMensalExercicio4.Text = servicosRecursosFinanceiroPrivadoMediaMensalExercicio4 != null ? servicosRecursosFinanceiroPrivadoMediaMensalExercicio4.MediaMensal != null ? servicosRecursosFinanceiroPrivadoMediaMensalExercicio4.MediaMensal.Value.ToString() : "0" : "0";
                #endregion
            }

            #endregion

            var recursoshumanos = proxy.Service.GetRecursosHumanosPrivadoByIdServicoRecursoFinanceiro(servico.Id);
            ...
            //lblTotalFuncionarios.Text = obj.TotalFuncionarios.ToString();
                    ...
                    if (servico.IdMotivoDesativacao.HasValue)
                    {
                        ...
                        switch (servico.IdMotivoDesativacao)
                        {
                            case 1:
                                ...
                                lblDataEncerramento.Text = servico.DataRegistroLog == null ? String.Empty : servico.DataRegistroLog.Value.ToShortDateString();
                            ...
                            case 2:
                                ...
                                lblDataEncerramento.Text = servico.DataDesativacao == null ? String.Empty : servico.DataDesativacao.Value.ToShortDateString();
            ...
            if (servico.ServicosRecursosFinanceirosFundosPrivadoInfo != null
                              && servico.ServicosRecursosFinanceirosFundosPrivadoInfo.Count > 0)
            {
                servico.ServicosRecursosFinanceirosFundosPrivadoInfo = servico.ServicosRecursosFinanceirosFundosPrivadoInfo.OrderBy(x => x.Exercicio).ToList();

                foreach (var fundo in servico.ServicosRecursosFinanceirosFundosPrivadoInfo)
                {
                    fundo.ServicoEstadualizado = fundo.ValorEstadualizado != 0M;
                }

                rptFundosAbas.DataSource = servico.ServicosRecursosFinanceirosFundosPrivadoInfo.Where(s => s.Exercicio >= 2022);
                rptFundosAbas.DataBind();

                rptFundosConteudo.DataSource = servico.ServicosRecursosFinanceirosFundosPrivadoInfo;
            ...
            var lstProgramas = proxyProgramas.Service.GetProgramaProjetoCofinanciamentoByServicoRecursoFinanceiro(Convert.ToInt32(Genericos.clsCrypto.Decrypt(Request.QueryString["id"])), 2);
            ...
            var lstTransferencias = proxyProgramas.Service.GetTransferenciaRendaCofinanciamentoByServicoRecursoFinanceiro(Convert.ToInt32(Genericos.clsCrypto.Decrypt(Request.QueryString["id"])), 2);
            ...
            var lstBeneficios = proxyProgramas.Service.GetBeneficioEventualServicosByServicoRecursoFinanceiro(Convert.ToInt32(Genericos.clsCrypto.Decrypt(Request.QueryString["id"])), 2);
        ...
        protected void btnVoltar_Click(object sender, EventArgs e)
        {
            if (!String.IsNullOrEmpty(Request.QueryString["idUnidade"]))
            {
                ...
                Response.Redirect("~/BlocoII/CServicosRecursosFinanceirosPrivado.aspx?idLocal=" + Server.UrlEncode(Genericos.clsCrypto.Encrypt(idLocal)) + "&idUnidade=" + Server.UrlEncode(Genericos.clsCrypto.Encrypt(idUnidade)));
                return;
            }
