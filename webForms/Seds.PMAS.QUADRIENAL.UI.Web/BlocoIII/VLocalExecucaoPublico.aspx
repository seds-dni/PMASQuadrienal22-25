<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="VLocalExecucaoPublico.aspx.cs" Inherits="Seds.PMAS.QUADRIENAL.UI.Web.BlocoIII.VLocalExecucaoPublico" %>
                ...
                <div class="accordion">
                    <div class="frame active">
                        <div class="heading">
                            ...
                            </a>3.3 - Dados deste local de execução desativado
                                ...
                                <div class="grid">
                                    <div class="row cells3">
                                        ...
                                        <div class="cells2">
                                            ...
                                            <div class="input-control text mid-size">
                                                <asp:Label ID="lblNome" runat="server" Width="100%" MaxLength="120"></asp:Label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row cell">
                                        <div class="cell">
                                            ...
                                            <div class="input-control text mid-size">
                                                <asp:Label ID="lblNomeLocalExecucao" runat="server" MaxLength="120"></asp:Label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row cell">
                                        <div class="cell">
                                            ...
                                            <div class="input-control text mid-size">
                                                <asp:Label ID="txtTecnicoResponsavel" runat="server" MaxLength="120" Width="100%"></asp:Label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row cells2">
                                        <div class="cell">
                                            ...
                                            <asp:Label ID="lblEmailInstitucional" runat="server" Width="308px"></asp:Label>
                                        </div>
                                        <div class="cell">
                                            <b>Imóvel:</b><br />
