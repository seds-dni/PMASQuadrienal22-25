<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VServicoRecursoFinanceiroCRAS.aspx.cs" Inherits="Seds.PMAS.QUADRIENAL.UI.Web.BlocoIII.VServicoRecursoFinanceiroCRAS" %>
                        ...
                        <div class="content">
                            <div class="formInput" data-text="Unidades Públicas">
                                <div class="grid">
                                    ...
                                    <div class="row cells2" id="tbNaoTipificado" runat="server" visible="false">
                                        <div class="cell">
                                            <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="cell">
                                            <b>Este serviço é ofertado pela Equipe Volante?</b><br />
                                            <asp:Label ID="lblEquipeVolante" runat="server" />
                                        </div>
                                    </div>
                                    <div class="row">
                                                                                ...
                                                                                <fieldset class="border-blue">
                                                                                    ...
                                                                                    <div class="row cells3">
                                                                                        ...
                                                                                        <div class="cell" id="trFeasAnterior" runat="server">
                                                                                            ...
                                                                                            <div class="input-control text">
                                                                                                <asp:Label ID="txtFEASAnoAnterior" runat="server" Enabled="false" Text='<%# DataBinder.Eval(Container.DataItem, "ValorEstadualAssistenciaAnoAnterior") == null ? "0,00" : DataBinder.Eval(Container.DataItem, "ValorEstadualAssistenciaAnoAnterior", "{0:0.00}") %>' Style="text-align: right;" />
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="cell">
                                                                                            <b>Direitos da Criança e do Adolescente:</b><br />
                                                                            ...
                                                                            <div id="trRecursosFinanceirosPublicos" runat="server" visible="true">
                                                                                <fieldset class="border-blue">
                                                                                    ...
                                                                                    <div class="row mid-size" id="tdlstRecursosAdicionados" runat="server" visible="true">
                                                                                        <asp:ListView ID="lstRecursosAdicionados" runat="server" DataKeyNames="Id" DataSource='<%# DataBinder.Eval(Container.DataItem, "ServicoRecursoFinanceiroCRASFontesRecursosInfo") %>'>
                                                                                            <LayoutTemplate>
                                    ...
                                    <div class="row" id="trServicosAssociados" runat="server">
                                        <fieldset class="border-blue">
                                            <legend class="lgnd"><b class="fg-blue">Integração com programas, projetos e benefícios:</b></legend>

                                            <fieldset runat="server" id="fldProgramas" >
                                                <legend class="lgnd"><b class="fg-blue">Programas</b></legend>
                                                <div class="row">
                                            ...
                                            <fieldset id="fldTransferenciaRenda" runat="server">
                                                <legend class="lgnd"><b class="fg-blue">Transferência de Renda</b></legend>
                                                <div class="cell">
                                                    <div class="cell" style="font-weight: bold">
                                            ...
                                            <fieldset id="fldBeneficiosEventuais" runat="server">
                                                <legend class="lgnd"><b class="fg-blue">Benefícios Eventuais</b></legend>
                                                <div class="row">
                                                    <div class="cell" style="font-weight: bold">
                                            ...
                                            <fieldset id="fldBeneficiosContinuados" class="border-blue" runat="server">
                                                <legend class="lgnd"><b class="fg-blue">Benefícios Continuados</b></legend>
                                                <div class="row">
                                                    <div class="cell" style="font-weight: bold">
