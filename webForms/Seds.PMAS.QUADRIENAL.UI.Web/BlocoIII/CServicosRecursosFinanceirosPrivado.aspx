<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="CServicosRecursosFinanceirosPrivado.aspx.cs" Inherits="Seds.PMAS.QUADRIENAL.UI.Web.BlocoIII.CServicosRecursosFinanceirosPrivado" %>
            ...
            <form name="frmUnidadesPublicas">
                <div class="accordion">
                    <div class="frame active">
                        <div class="heading">
                            </a>3.14 - Serviços socioassistenciais executados no 
                                        <asp:Label ID="lblLocalExecucao" runat="server" /></b>
                            <a href="#" runat="server" id="linkAlteracoesQuadro39" visible="false">
                                            ...
                                            <table class="table striped border bordered" cellspacing="0"
                                                ...
                                                <thead class="info">
                                                    <tr>
                                                        ...
                                                        <th width="100">Estadualizado
                                                        </th>
                                                        <th width="100">Cofinanciamento estadual                                              
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:ListView ID="lstItems" runat="server" DataSource='<%#Eval("Items") %>'  OnItemDataBound="lstItems_ItemDataBound">
                                                ...
                                                <ItemTemplate>
                                                    <tr>
                                                        <td align="center">
                                                            <a href="VServicoRecursoFinanceiroPrivado.aspx?id=<%# Server.UrlEncode(Genericos.clsCrypto.Encrypt(DataBinder.Eval(Container.DataItem, "Id").ToString())) %>&idLocal=<%=Server.UrlEncode(Request.QueryString["idLocal"])%>&idUnidade=<%=Server.UrlEncode(Request.QueryString["idUnidade"])%>">
                                                ...
                                                <%#DataBinder.Eval(Container.DataItem, "Abrangencia") %>
                                                        ...
                                                        <td align="center">
                                                            <%#((Boolean)DataBinder.Eval(Container.DataItem, "obj.ServicoEstadualizado")) ? "Sim" : "Não"%>
                                                        </td>
                                                      <td align="center">
                                                            <div style="width: 100%; height: 22px; padding: 2px; font-size: 10px; text-align: center;">
                                                      ...
                                                      <%--      <%#MontarBotaoExcluir((Seds.PMAS.QUADRIENAL.Entidades.Estruturas.ConsultaServicosRecursosFinanceirosPrivadoInfo)Container.DataItem) %>--%>
                                                        </td>
                                                    </tr>
                                                </ItemTemplate>
                                            </asp:ListView>
                                    ...
                                    <div class="row" align="center">
                                        <div class="cell">
                                            <asp:Button ID="btnAdicionarServico" runat="server" Text="Adicionar Serviços e Recursos Financeiros"
                                                SkinID="button-save" OnClick="btnAdicionarServico_Click" Width="280px" />
