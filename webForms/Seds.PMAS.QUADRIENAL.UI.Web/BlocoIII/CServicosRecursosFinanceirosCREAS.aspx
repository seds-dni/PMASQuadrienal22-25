<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="CServicosRecursosFinanceirosCREAS.aspx.cs" Inherits="Seds.PMAS.QUADRIENAL.UI.Web.BlocoII.CServicosRecursosFinanceirosCREAS" %>
            ...
            <form name="frmUnidadesPublicas">
                <div class="accordion">
                    <div class="frame active">
                        <div class="heading">
                            <a href="#" runat="server" id="linkAlteracoesQuadro29" visible="false">
                                <img src="../Styles/Icones/irkickflash.png" align="absMiddle" border="0" />Alterado
                            </a>&nbsp; 3.8 - Serviços socioassistenciais executados no&nbsp;
                                    ...
                                    <div class="row">
                                                ...
                                                <table class="table striped border bordered" cellspacing="0"
                                                    ...
                                                    <thead class="info">
                                                        <tr>
                                                            ...
                                                            <th width="140">Capacidade mensal de pessoas/famílias atendidas
                                                            </th>
                                        ...
                                        <div class="row">
                                            <div class="cell">
                                                ...
                                                &nbsp;<asp:Button ID="btnVoltar" SkinID="button-save" runat="server" Text="Voltar" OnClick="btnVoltar_Click" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
