<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FMotivoExclusaoCRAS.aspx.cs" Inherits="Seds.PMAS.QUADRIENAL.UI.Web.BlocoIII.FMotivoExclusaoCRAS" %>
                        ...
                        <div class="grid">
                            <div class="row">
                                <fieldset class="border-blue">
                                    ...
                                    <div class="row">
                                        <div class="cell">
                                            Para proceder à desativação deste CRAS no sistema PMASweb, registre as informações solicitadas.
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="cell">
                                            ...
                                            <div class="row" id="trDataEncerramento" runat="server" visible="false">
                                                <div class="cell">
                                                    <b>
                                                        Data do encerramento das atividades deste CRAS:&nbsp;</b><uc4:data id="txtDataEncerramento" runat="server" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="cell" align="center">
                                                    <asp:Button ID="btnSalvar" runat="server" OnClick="btnSalvar_Click" SkinID="button-save" Text="Salvar" Width="89px" OnClientClick="return confirm('Tem certeza que deseja desativar este CRAS?');" />
