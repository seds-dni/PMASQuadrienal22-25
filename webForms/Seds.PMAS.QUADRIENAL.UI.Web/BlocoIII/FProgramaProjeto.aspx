<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" Async="true"
    CodeBehind="FProgramaProjeto.aspx.cs" Inherits="Seds.PMAS.QUADRIENAL.UI.Web.BlocoIII.FProgramaProjeto" %>
                                ...
                                <div class="grid">
                                    ...
                                    <div class="row" id="trBeneficiarios" runat="server" visible="false">
                                        <div class="cell">
                                            ...
                                            <div class="input-control select mid-size" id="trddlBeneficiarios" runat="server" visible="false">
                                    ...
                                    <div class="row" id="trExecutaPrograma" runat="server" visible="false">
                                        <div class="cell">
                                            <strong>
                                                <asp:Label ID="lblPerguntaPrograma" runat="server"></asp:Label></strong>
                                            <asp:RadioButtonList ID="rblExecutaPrograma" runat="server" RepeatDirection="Horizontal"
                                                RepeatColumns="2" CellSpacing="5" Width="150" OnSelectedIndexChanged="rblExecutaPrograma_SelectedIndexChanged" AutoPostBack="True">
                                                <asp:ListItem Value="1">Sim</asp:ListItem>
                                                <asp:ListItem Value="0">Não</asp:ListItem>
                                            </asp:RadioButtonList>
                                        </div>
                                    ...
                                    <div class="row" id="trAcoesSocioassistenciais" runat="server" visible="false">
                                        <div class="cell">
                                            <b>Trabalho Social</b>
                                            <asp:CheckBoxList ID="chkAcoesSocioassistenciais" RepeatDirection="Horizontal"
                                                RepeatColumns="2" CellSpacing="5" Width="100%" runat="server" />
                                        </div>
                                    </div>

                                    <!--Acessuas-->
                                    <div class="row" id="trAderenciaACESSUAS" runat="server" visible="false">
                                        <div class="cell" colspan="2">
                                            <b>O município realizou aceite para executar o Programa Nacional de Promoção do Acesso ao Mundo do Trabalho - ACESSUAS TRABALHO?</b><br />
                                            <asp:RadioButtonList ID="rblAderenciaACESSUAS" runat="server" AutoPostBack="true" OnSelectedIndexChanged="rblAderenciaACESSUAS_SelectedIndexChanged" RepeatDirection="Horizontal">
                                    ...
                                    <div class="row" id="trInterlocutorMunicipal" runat="server" visible="false">
                                        <fieldset class="border-blue">
                                            <legend class="lgnd"><b class="fg-blue">
                                                <asp:Label ID="lblTituloQuadroInterlocutor" runat="server" Text="Interlocutor Municipal" />
                                            </b></legend>
                                            <div class="row" id="trAdesaoPrograma" runat="server" visible="false">
                                                <div class="cell">
                                                    <div class="row">
                                                        <div class="cell">
                                                            <b>Data de assinatura do termo de Adesão do Programa Família Paulista com a SEDS:</b>
                                                            <br />
                                                            <uc4:data ID="txDtAdesaoPrograma" runat="server" />
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="cell">
                                                            <b>Meta proposta pela SEDS:&nbsp; </b>
                                                            <div class="input-control text">
                                                                <asp:TextBox ID="txtMetaPrograma" runat="server"></asp:TextBox>
                                                            </div>
                                                            <asp:ImageButton ID="btnAjudaMetaSEDS" runat="server" ImageAlign="AbsMiddle" ImageUrl="~/Styles/Icones/help.png" OnClientClick="return false;" />
                                                            <asp:Panel ID="pnlAjudaMetaSEDS" runat="server" CssClass="ajuda" Height="100px" Width="400px">
                                                                <div style="float: right;">
                                                                    <asp:LinkButton ID="lnkCloseAjudaMetaSEDS" runat="server" OnClientClick="return false;" Style="background-color: #666666; color: #FFFFFF; text-align: center; font-weight: bold; text-decoration: none; border: outset thin #FFFFFF; padding: 5px;" Text="X" ToolTip="Fechar" />
                                                                </div>
                                                                <div>
                                                                    <p>
                                                                        A meta proposta pela SEDS é o número de famílias em extrema pobreza cadastradas no CadÚnico em dezembro de 2015, multiplicado pelo coeficiente segundo o porte do município.
                                                                    </p>
                                                                </div>
                                                            </asp:Panel>
                                                            <ajaxToolkit:AnimationExtender ID="OpenAnimationAjudaMetaSEDS" runat="server" TargetControlID="btnAjudaMetaSEDS">
                                                                <Animations>
                                        <OnClick>
                                            <Sequence AnimationTarget="pnlAjudaMetaSEDS">
                                            <EnableAction AnimationTarget="btnAjudaMetaSEDS" Enabled="false" />
                                            ...
                                            <Parallel>
                                                <FadeIn Duration="1" Fps="20" />                                    
                                                            ...
                                                            <ajaxToolkit:AnimationExtender ID="CloseAnimationAjudaMetaSEDS" runat="server" TargetControlID="lnkCloseAjudaMetaSEDS">
                                                                <Animations>
                                                    <OnClick>
                                                        <Sequence AnimationTarget="pnlAjudaMetaSEDS">                                                    
                                                            ...
                                                            <EnableAction AnimationTarget="btnAjudaMetaSEDS" Enabled="true" />
                                                        </Sequence>
                                                    </OnClick>
                                                    <OnMouseOver>
                                                    ...
                                                    <div class="row">
                                                        <div class="cell">
                                                            <b>Meta definida pelo município:&nbsp;</b>
                                                            <div class="input-control text">
                                                                <asp:TextBox ID="txtPrevisaoBeneficiarios" runat="server"></asp:TextBox>
                                                            </div>
                                                            <asp:ImageButton ID="btnAjudaPrevisao" runat="server" ImageAlign="AbsMiddle" ImageUrl="~/Styles/Icones/help.png" OnClientClick="return false;" />
                                                            <asp:Panel ID="pnlAjudaPrevisao" runat="server" CssClass="ajuda" Height="100px" Width="400px">
                                                                <div style="float: right;">
                                                                    <asp:LinkButton ID="lnkCloseAjudaPrevisao" runat="server" OnClientClick="return false;" Style="background-color: #666666; color: #FFFFFF; text-align: center; font-weight: bold; text-decoration: none; border: outset thin #FFFFFF; padding: 5px;" Text="X" ToolTip="Fechar" />
                                                                </div>
                                                                <div>
                                                                    <p>
                                                                        A meta definida pelo município é o número de famílias em extrema pobreza cadastradas no CadÚnico que o município atenderá no programa, devendo ser menor ou igual à meta proposta pela SEDS.
                                                                    </p>
                                                                </div>
                                                            </asp:Panel>
                                                            <ajaxToolkit:AnimationExtender ID="OpenAnimationPrevisao" runat="server" TargetControlID="btnAjudaPrevisao">
                                                                <Animations>
                                        <OnClick>
                                            <Sequence AnimationTarget="pnlAjudaPrevisao">
                                            <EnableAction AnimationTarget="btnAjudaPrevisao" Enabled="false" />
                                            <StyleAction Attribute="display" Value="block" />                                    
                                            <Parallel>
                                                <FadeIn Duration="1" Fps="20" />                                    
                                            </Parallel>
                                                            ...
                                                            <ajaxToolkit:AnimationExtender ID="CloseAnimationAjudaPrevisao" runat="server" TargetControlID="lnkCloseAjudaPrevisao">
                                                                <Animations>
                                                    <OnClick>
                                                        <Sequence AnimationTarget="pnlAjudaPrevisao">                                                    
                                                            <Parallel Duration=".3" Fps="15">                                                        
                                                            ...
                                                            <%--  Enable the button so it can be played again --%>
                                                            <EnableAction AnimationTarget="btnAjudaPrevisao" Enabled="true" />
                                                        </Sequence>
                                                    </OnClick>
                                                    <OnMouseOver>
                                                        <Color Duration=".2" PropertyKey="color" StartValue="#FFFFFF" EndValue="#FF0000" />
                                            ...
                                            <div class="row">
                                                <div class="cell">
                                                    <b>
                                                        <asp:Label ID="lblInterlocutor" runat="server" Text="Nome do técnico responsável pelo programa:"></asp:Label></b><br />
                                                    <div class="input-control text mid-size">
                                                        <asp:TextBox ID="txtNomeTecnico" runat="server" MaxLength="120" Width="300px"></asp:TextBox>
                                                    </div>
                                                </div>
                                                <div class="cell">
                                                    <asp:CheckBox ID="chkNaoPossuiTecnico" runat="server" AutoPostBack="True" OnCheckedChanged="chkNaoPossuiTecnico_CheckedChanged" Text="Não há técnico responsável por este programa" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="cell">
                                                    ...
                                                    <div class="input-control text mid-size">
                                                        <asp:TextBox ID="txtEmailInstitucional" runat="server" MaxLength="120"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                        </fieldset>
                                    ...
                                    <div class="row" id="trMetaPactuada" runat="server" visible="false">
                                        <fieldset class="border-blue">
                                            <legend class="lgnd"><b class="fg-blue"><asp:Label ID="lblMetaLogo" runat="server"></asp:Label>
                                                <%-- <asp:Label ID="lblQuadro" runat="server" Text="Previsão anual de número de beneficiários e valor de repasse" />--%>
                                            ...
                                            <div class="row cells2" id="trPrevisaoAnual4" runat="server">
                                                    <b>Previsão anual do valor do repasse: (R$:100,00 x 12 meses x meta pactuada)</b>
                                            </div>
                                    ...
                                    <div class="row" id="trConstrucaoUnidadesIdoso" runat="server" visible="false">
                                        <fieldset class="border-blue">
                                            <legend class="lgnd"><b class="fg-blue">Centro de Convivência do Idoso e/ou Centro de Longevidade Ativa</b></legend>
                                            <div class="row">
                                                <div class="cell">Caso o município tenha assinado convênio com o governo estadual, em qualquer data, para construção de equipamento para atendimento de idosos, informe nos campos abaixo os valores recebidos. </div>
                                            </div>
                                            <div class="row">
                                                <fieldset class="border-blue">
                                                    <legend class="lgnd"><b class="fg-blue">Centro Dia do Idoso</b></legend>
                                                    <div class="row">
                                                        <div class="cell">
                                                            O município assinou convênio com o governo estadual, em qualquer data, para construção de centro dia do idoso?<br />
                                                            <asp:RadioButtonList ID="rblAssinouCentroIdoso" runat="server" OnSelectedIndexChanged="rblAssinouCentroIdoso_SelectedIndexChanged" AutoPostBack="true" RepeatDirection="Horizontal">
                                                                <asp:ListItem Value="1">Sim</asp:ListItem>
                                                                <asp:ListItem Value="0">Não</asp:ListItem>
                                                            </asp:RadioButtonList>
                                                        </div>
                                                    ...
                                                    <asp:Panel runat="server" ID="pnlParcelasCentroDiaDoIdoso">
                                                        <fieldset class="border-blue">
                                                            ...
                                                            <div class="row cells2">
                                                                ...
                                                                <div class="cell">
                                                                    ...
                                                                    R$
                                                                <div class="input-control text">
                                                                    <asp:TextBox ID="txtValorDiaIdoso" runat="server"></asp:TextBox>
                                                                </div>
                                                                </div>
                                                                <div class="cell">
                                                                    <b>Mês e ano em que foi realizado o repasse</b><br />
                                                                    Mês:
                                                                    <div class="input-control select">
                                                                        <asp:DropDownList ID="ddlMesRepasseDiaIdoso" runat="server">
                                                                            <asp:ListItem Selected="True" Text="[Selecione o mês]" Value="0" />
                                                                            <asp:ListItem Text="Janeiro" Value="1" />
                                                                            <asp:ListItem Text="Fevereiro" Value="2" />
                                                                            <asp:ListItem Text="Março" Value="3" />
                                                                    ...
                                                                    &nbsp; &nbsp;
                                                                        Ano:
                                                                    <div class="input-control text">
                                                                        <asp:TextBox ID="txtAnoRepasseDiaIdoso" runat="server" MaxLength="4" Width="50px" />
                                                                    </div>
                                                                    <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtendertxtAnoRepasseDiaIdoso" runat="server" FilterType="Numbers" TargetControlID="txtAnoRepasseDiaIdoso" />
                                                                </div>
                                                            </div>
                                                        </fieldset>
                                                        <fieldset class="border-blue">
                                                            <legend class="lgnd"><b class="fg-blue">2 Parcela</b></legend>
                                                            <div class="row cells2">
                                                                ...
                                                                <div class="cell">
                                                                    ...
                                                                    R$
                                                                <div class="input-control text">
                                                                    <asp:TextBox ID="txtValorDiaIdoso2" runat="server"></asp:TextBox>
                                                                </div>
                                                                </div>
                                                                <div class="cell">
                                                                    <b>Mês e ano em que foi realizado o repasse</b><br />
                                                                    Mês:
                                                                    <div class="input-control select">
                                                                        <asp:DropDownList ID="ddlMesRepasseDiaIdoso2" runat="server">
                                                                            <asp:ListItem Selected="True" Text="[Selecione o mês]" Value="0" />
                                                                            <asp:ListItem Text="Janeiro" Value="1" />
                                                                            <asp:ListItem Text="Fevereiro" Value="2" />
                                                                            <asp:ListItem Text="Março" Value="3" />
                                                                    ...
                                                                    &nbsp; &nbsp;
                                                                        Ano:
                                                                    <div class="input-control text">
                                                                        <asp:TextBox ID="txtAnoRepasseDiaIdoso2" runat="server" MaxLength="4" Width="50px" />
                                                                    </div>
                                                                    <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtendertxtAnoRepasseDiaIdoso2" runat="server" FilterType="Numbers" TargetControlID="txtAnoRepasseDiaIdoso2" />
                                                                </div>
                                                            </div>
                                                        </fieldset>
                                                        <div class="row">
                                                            <div class="cell">
                                                                Data de início de funcionamento deste equipamento (ou previsão):
                                                            <uc4:data ID="txtDataInauguracaoCentroDia" runat="server" />
                                                            </div>
                                                        </div>
                                                        <div class="row cells2">
                                                            <div class="cell">
                                                            ...
                                                            <div class="input-control select mid-size">
                                                                <asp:DropDownList ID="ddlCREASReferencia" runat="server">
                                                                </asp:DropDownList>
                                                            </div>
                                                            </div>
                                                            <div class="cell" style="padding-top: 10px;">
                                                                <asp:CheckBox ID="chkNaohaCreas" runat="server" Text="O município não possui nenhum CREAS implantado" OnCheckedChanged="chkNaohaCreas_CheckedChanged" AutoPostBack="true" />
                                                            </div>
                                                        </div>
                                                    </asp:Panel>
                                            ...
                                            <div class="row">
                                                <fieldset class="border-blue">
                                                    <legend class="lgnd"><b class="fg-blue">Centro de Convivência do Idoso / Centro de Longevidade Ativa</b></legend>
                                                    <div class="row">
                                                        <div class="cell">
                                                            O município assinou convênio com o governo estadual, em qualquer data, para construção de centro convivência do idoso?<br />
                                                            <asp:RadioButtonList ID="rblAssinouCentroConvivencia" runat="server" OnSelectedIndexChanged="rblAssinouCentroConvivencia_SelectedIndexChanged" AutoPostBack="true" RepeatDirection="Horizontal">
                                                                <asp:ListItem Value="1">Sim</asp:ListItem>
                                                                <asp:ListItem Value="0">Não</asp:ListItem>
                                                            </asp:RadioButtonList>
                                                        </div>
                                                    ...
                                                    <!-- Aqui -->
                                                    <asp:Panel runat="server" ID="pnlParcelasCentroConvivenciaDoIdoso">
                                                        <fieldset class="border-blue">
                                                            <legend class="lgnd"><b class="fg-blue">1 Parcela</b></legend>
                                                            <div class="row cells2">
                                                                <div class="cell">
                                                                    ...
                                                                    R$
                                                            <div class="input-control text">
                                                                <asp:TextBox ID="txtValorConvivenciaIdoso" runat="server"></asp:TextBox>
                                                            </div>
                                                                </div>
                                                                <div class="cell">
                                                                    <b>Mês e ano em que foi realizado o repasse </b>
                                                                    <br />
                                                                    Mês:
                                                                <div class="input-control select">
                                                                    <asp:DropDownList ID="ddlMesRepasseConvivenciaIdoso" runat="server">
                                                                        <asp:ListItem Selected="True" Text="[Selecione o mês]" Value="0" />
                                                                        <asp:ListItem Text="Janeiro" Value="1" />
                                                                        <asp:ListItem Text="Fevereiro" Value="2" />
                                                                        <asp:ListItem Text="Março" Value="3" />
                                                                    ...
                                                                    &nbsp; &nbsp;Ano: 
                                                            <div class="input-control text">
                                                                <asp:TextBox ID="txtAnoRepasseConvivenciaIdoso" runat="server" MaxLength="4" Width="50px" />
                                                            </div>
                                                                    <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtendertxtAnoRepasseConvivenciaIdoso" runat="server" FilterType="Numbers" TargetControlID="txtAnoRepasseConvivenciaIdoso" />
                                                                </div>
                                                            </div>
                                                        </fieldset>
                                                        <fieldset class="border-blue">
                                                            ...
                                                            <div class="row cells2">
                                                                <div class="cell">
                                                                    ...
                                                                    R$
		                                                    <div class="input-control text">
                                                                <asp:TextBox ID="txtValorConvivenciaIdoso2" runat="server"></asp:TextBox>
                                                            </div>
                                                                </div>
                                                                <div class="cell">
                                                                    <b>Mês e ano em que foi realizado o repasse </b>
                                                                    ...
                                                                    Mês:
			                                                    <div class="input-control select">
                                                                    <asp:DropDownList ID="ddlMesRepasseConvivenciaIdoso2" runat="server">
                                                                        <asp:ListItem Selected="True" Text="[Selecione o mês]" Value="0" />
                                                                        <asp:ListItem Text="Janeiro" Value="1" />
                                                                        <asp:ListItem Text="Fevereiro" Value="2" />
                                                                        <asp:ListItem Text="Março" Value="3" />
                                                                    ...
                                                                    &nbsp; &nbsp;Ano: 
		                                                    <div class="input-control text">
                                                                <asp:TextBox ID="txtAnoRepasseConvivenciaIdoso2" runat="server" MaxLength="4" Width="50px" />
                                                            </div>
                                                                    <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtendertxtAnoRepasseConvivenciaIdoso2" runat="server" FilterType="Numbers" TargetControlID="txtAnoRepasseConvivenciaIdoso2" />
                                                                </div>
                                                            </div>
                                                        </fieldset>
                                                        ...
                                                        <div class="row">
                                                            <div class="cell">
                                                                Data de início de funcionamento deste equipamento (ou previsão):
                                                            <uc4:data ID="txtDataInauguracaoCentroConvivencia" runat="server" />
                                                            </div>
                                                        </div>
                                                        <div class="row cells2">
                                                            <div class="cell">
                                                                CRAS de referência:
                                                            <div class="input-control select mid-size">
                                                                <asp:DropDownList ID="ddlCRASReferencia" runat="server">
                                                                </asp:DropDownList>
                                                            </div>
                                                            </div>
                                                            <div class="cell" style="padding-top: 10px;">
                                                                <asp:CheckBox ID="chkNaohaCras" runat="server" Text="O município não possui nenhum CRAS implantado" OnCheckedChanged="chkNaohaCras_CheckedChanged" AutoPostBack="true" />
                                                            </div>
                                                        </div>
                                                    </asp:Panel>
                                    ...
                                    <div class="row" id="trSeloAmigoIdoso" runat="server" visible="false">
                                        <fieldset class="border-blue">
                                            <legend class="lgnd"><b class="fg-blue">Selo Paulista da Longevidade</b></legend>
                                            <div class="row">
                                                <div class="cell">
                                                    Data de assinatura do Termo de Adesão ao Selo Amigo do Idoso:
                                                    <uc4:data ID="txtDataAdesaoSeloIdoso" runat="server" />
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="cell">
                                                    <b>Informe quais ações já foram realizadas pelo município para obtenção do selo de município Amigo do Idoso:</b><br />
                                                    <asp:CheckBoxList ID="chkAcoesRealizadasIdoso" runat="server">
                                                    </asp:CheckBoxList>
                                                </div>
                                            </div>
                                        </fieldset>
                                            ...
                                            <div class="row" id="tbParcerias" runat="server" visible="false" style="margin-left: 10px;">
                                                ...
                                                <asp:UpdatePanel ID="upParceria1" runat="server" UpdateMode="Conditional">
                                                    <ContentTemplate>
                                                        <div class="row">
                                                            <div class="cell">
                                                                ...
                                                                <%--<asp:Button ID="btnAdicionarGrupoGestor" runat="server" SkinID="button-save" Text="Adicionar Grupo Gestor" OnClick="btnAdicionarGrupoGestor_Click" />--%>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                    ...
                                                    <Triggers>
                                                        ...
                                                        <%--<asp:AsyncPostBackTrigger ControlID="btnAdicionarGrupoGestor" EventName="Click" />--%>
                                                    </Triggers>
                                                </asp:UpdatePanel>
                                                <%--<div class="row" id="trGrupoGestor" runat="server" visible="false">
                                                    <div class="cell">
                                                        <asp:ListView ID="lstGrupoGestor" runat="server" OnItemCommand="lstGrupoGestor_ItemCommand" OnItemDataBound="lstGrupoGestor_ItemDataBound">
                                                            <LayoutTemplate>
                                                                <table border="0" cellpadding="0" cellspacing="0" class="table border bordered">
                                                                    <thead class="info">
                                                                        <tr>
                                                                            <th colspan="4" tyle="height: 22px;">Constituição do grupo gestor do Programa Família Paulista</th>
                                                                        </tr>
                                                                        <tr>
                                                                            <th style="height: 22px;" width="20"></th>
                                                                            <th width="270">Tipo de organização </th>
                                                            ...
                                                            <ItemTemplate>
                                                                <tr>
                                                                    ...
                                                                    <td align="left"><%#DataBinder.Eval(Container.DataItem, "Parceria.Nome") %></td>
                                                                    <td align="left"><%#DataBinder.Eval(Container.DataItem, "Nome") %></td>
                                                                    <td class="align-center">
                                                                        <asp:ImageButton ID="btnExcluirGrupoGestor" runat="server" CausesValidation="false" CommandName="Excluir" ImageUrl="~/Styles/Icones/editdelete.png" OnClientClick="return confirm('Deseja realmente remover a parceria?');" />
                                                                    </td>
                                                                </tr>
                                                            </ItemTemplate>
                                                        </asp:ListView>
                                            ...
                                            <div class="row" id="trParcela1" runat="server" visible="false">
                                                <div class="cell">
                                                    <fieldset class="border-blue">
                                                        ...
                                                        <div class="row">
                                                            <div class="cell">
                                                                Valor programado para utilização em 2020:
                                                                <div class="input-control text">
                                                        ...
                                                        <div class="row">
                                                            <div class="cell">
                                                                Valor programado para utilização em 2021:
                                                                <div class="input-control text">
