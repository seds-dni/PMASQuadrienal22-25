<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="VCentroPOP.aspx.cs" Inherits="Seds.PMAS.QUADRIENAL.UI.Web.BlocoIII.VCentroPOP" %>
                            ...
                            <div class="formInput" data-text="CRAS">
                                <div class="grid">
                                    ...
                                    <div class="row cells2">
                                        ...
                                        <div class="cell">
                                            <b>Data do encerramento das atividades deste Centro POP:</b><br />
                                    ...
                                    <div class="row" id="trMotivoEncerramento" runat="server" visible="false">
                                        <div class="cell">
                                            <b>O encerramento das atividades deste Centro POP deve-se a:</b><br />
                                    ...
                                    <div class="row">
                                        <div class="cell">
                                            <fieldset class="border-blue">
                                                ...
                                                <div class="row">
                                                    <div class="cell">
                                                        O órgão gestor deve informar somente as ações atualmente realizadas pelo Centro POP. As que ainda estão em planejamento devem integrar as informações do bloco de Planejamento.
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="cell">
                                                        <b>Este Centro POP oferta o Serviço Especializado para Pessoas em Situação de Rua?</b><br />
                                                        <asp:Label ID="lblServicoPSR" runat="server" />
                                                    </div>
                                                </div>
                                                <div class="row" id="trJustificativaPSR" runat="server" visible="true">
                                                    <div class="cell">
                                                        <b>Justifique:</b><br />
                                                        <asp:Label ID="txtJustificativaPSR" runat="server" TextMode="MultiLine" />
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="cell">
                                                        <b>Quais atividades são desenvolvidas por este Centro POP?
                                                        </b>
                                                        <br />
