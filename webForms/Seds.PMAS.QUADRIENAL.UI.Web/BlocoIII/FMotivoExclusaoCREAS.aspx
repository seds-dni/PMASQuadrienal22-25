<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FMotivoExclusaoCREAS.aspx.cs" Inherits="Seds.PMAS.QUADRIENAL.UI.Web.BlocoIII.FMotivoExclusaoCREAS" %>
                                ...
                                <fieldset class="border-blue">
                                    ...
                                    <div class="row">
                                        <div class="cell">
                                            <div class="row">
                                                <div class="cell">
                                                    Para proceder à desativação deste CREAS no sistema PMASweb, registre as informações solicitadas
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="cell">
                                            ...
                                            <div class="row" id="trDataEncerramento" runat="server" visible="false">
                                                <div class="cell">
                                                    <b>Data de encerramento das atividades deste CREAS:&nbsp;</b><uc4:data ID="txtDataEncerramento" runat="server" />
                                                </div>
                                            </div>
                                            <div class="row" id="trMotivoEncerramento" runat="server" visible="false">
                                                <div class="cell">
                                                    <b>O encerramento das atividades deste CREAS deveu-se a:</b><br />
                                            ...
                                            <div class="row">
                                                <div class="cell" align="center">
                                                    <asp:Button ID="btnSalvar" runat="server" OnClick="btnSalvar_Click" SkinID="button-save" Text="Salvar" Width="89px" OnClientClick="return confirm('Tem certeza que deseja desativar este CREAS?');" />
