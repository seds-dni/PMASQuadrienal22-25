<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="CServicosRecursosFinanceirosCRAS.aspx.cs" Inherits="Seds.PMAS.QUADRIENAL.UI.Web.BlocoII.CServicosRecursosFinanceirosCRAS" %>
                ...
                <div class="accordion">
                    <div class="frame active">
                        <div class="heading">
                          ...
                          3.6 - Serviços socioassistenciais executados no&nbsp;
                          <asp:Label ID="lblCRAS" runat="server" />
                                ...
                                <div class="grid">
                                    <div class="row">
                                        <asp:ListView ID="lstRecursos" runat="server" OnItemCommand="lstRecursos_ItemCommand">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:ListView ID="lstItems" runat="server" DataSource='<%#Eval("Items") %>' OnItemDataBound="lstItems_ItemDataBound">
                                                    ...
                                                    <ItemTemplate>
                                                        <tr>
                                                            <td align="center">
                                                                <a href="VServicoRecursoFinanceiroCRAS.aspx?id=<%# Server.UrlEncode(Genericos.clsCrypto.Encrypt(DataBinder.Eval(Container.DataItem, "Id").ToString())) %>&idCentro=<%=Server.UrlEncode(Request.QueryString["id"])%>&idUnidade=<%=Server.UrlEncode(Request.QueryString["idUnidade"])%>">
                                            ...
                                            <%--                <td align="center">
                                                                 <div style="width: 100%; height: 22px; padding: 2px; font-size: 10px; text-align: center;">
                                                                <asp:Repeater ID="rptPrevisoes" runat="server" DataSource='<%#DataBinder.Eval(Container.DataItem, "Previsoes") %>'>
                                                                    <HeaderTemplate>
                                                                    </HeaderTemplate>
                                                                    <ItemTemplate>
                                                                        <asp:Panel ID="painelConfinanciamentoExercicio1" runat="server" Visible='<%# ((int)DataBinder.Eval(Container.DataItem, "Exercicio") == 2018)? true : false %>'>
                                                                            <div style="width: 50%; float: left; padding-left: 2px; margin-top: 2px;">
                                                                                ...
                                                                                <div style="width: 50%; height: 75%; padding: 2px; font-size: 10px; text-align: center;">
                                                                                    <div style="width: 50%; float: left; padding-left: 2px; padding: 3px;">
                                                                                        <%#String.Format("{0:N2}", DataBinder.Eval(Container.DataItem, "ValorPrevisaoOrcamentaria") ) %>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </asp:Panel>
