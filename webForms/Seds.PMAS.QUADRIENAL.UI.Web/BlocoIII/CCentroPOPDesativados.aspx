<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="CCentroPOPDesativados.aspx.cs" Inherits="Seds.PMAS.QUADRIENAL.UI.Web.BlocoIII.CCentroPOPDesativados" %>
                                            ...
                                            <asp:ListView ID="lstCentroPOP" runat="server" DataKeyNames="Id" OnItemDataBound="lstCentroPOP_ItemDataBound"
                                                ...
                                                <EmptyDataTemplate>
                                                    <div align="center" style="width: 100%;">
                                                        <b class="titulo">Não existe registro de Centro POP desativados</b>
                                                    </div>
                                                </EmptyDataTemplate>
                                            </asp:ListView>
                                            <div class="row">
