<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="CServicosRecursosFinanceirosPrivadoDesativado.aspx.cs" Inherits="Seds.PMAS.QUADRIENAL.UI.Web.BlocoII.CServicosRecursosFinanceirosPrivadoDesativado" %>
                            ...
                            <div class="formInput" data-text="Serviços">
                                <div class="grid">
                                        ...
                                        <ItemTemplate>
                                            <tr class="frame" style="height: 22px;">
                                                <td class="heading" colspan="7">
                                                    <b>Proteção Social:</b>
                                                    <%#DataBinder.Eval(Container.DataItem, "NomeProtecaoSocial") %>
                                                </td>
                                            </tr>
                                            <asp:ListView ID="lstItens" ItemPlaceholderID="itemPlaceholderRecursos" runat="server" DataSource='<%#DataBinder.Eval(Container.DataItem, "Recursos") %>'>
                                                <LayoutTemplate>
                                                    <tr id="itemPlaceholderRecursos" runat="server">
                                                    </tr>
                                                </LayoutTemplate>
                                                <ItemTemplate>
                                  ...
                                  <%--              <%#MontarBotaoEditar((Seds.PMAS.QUADRIENAL.Entidades.Estruturas.ConsultaServicosRecursosFinanceirosPublicoInfo)Container.DataItem) %>--%>
                                                        ...
                                                        <td align="center">
                                                            <%#((DateTime)DataBinder.Eval(Container.DataItem, "obj.DataExclusaoServico")).ToShortDateString() %>
                                                        </td>
