<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FMotivoExclusaoServicoCREAS.aspx.cs" Inherits="Seds.PMAS.QUADRIENAL.UI.Web.BlocoIII.FMotivoExclusaoServicoCREAS" %>
                                ...
                                <fieldset class="border-blue">
                                    ...
                                    <div class="row">
                                        <div class="cell" align="center">
                                            ...
                                            <asp:Button ID="btnSalvar" runat="server" Text="Salvar" SkinID="button-save" Width="89px" OnClick="btnSalvar_Click" OnClientClick="return confirm('Deseja realmente desativar este serviço?');" Visible="false" />
