<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FMotivoExclusaoCentroPOP.aspx.cs" Inherits="Seds.PMAS.QUADRIENAL.UI.Web.BlocoIII.FMotivoExclusaoCentroPOP" %>
                ...
                <div class="content">
                    <div class="formInput">
                        <div class="grid">
                            <div class="row">
                                <div class="cell">
                                    Para proceder à desativação deste Centro Pop no sistema PMASweb, registre as informações solicitadas
                                </div>
                            </div>
                            <div class="row">
                                <fieldset class="border-blue">
                                    ...
                                    <div class="row">
                                        <div class="cell">
                                            ...
                                            <div class="row">
                                                <div class="cell">
                                                    <b>A desativação deste Centro POP é devida a:</b><br />
                                            ...
                                            <div class="row" id="trDataEncerramento" runat="server" visible="false">
                                                <div class="cell">
                                                    <b>Data do encerramento das atividades deste CRAS&nbsp;</b><uc4:data ID="txtDataEncerramento" runat="server" />
                                                </div>
                                            </div>
                                            <div class="row" id="trMotivoEncerramento" runat="server" visible="false">
                                                <div class="cell">
                                                    <b>O encerramento das atividades deste Centro POP deveu-se a:</b><br />
                                            ...
                                            <div class="row" id="trDetalhamento" runat="server" visible="false">
                                                <div class="cell">
                                                    <div class="input-control text big-input full-size" data-role="input">
                                                        <b>Detalhamento sobre o motivo do encerramento das atividades deste Centro POP:</b><br />
                                            ...
                                            <div class="row">
                                                <div class="cell" align="center">
                                                    <asp:Button ID="btnSalvar" runat="server" OnClick="btnSalvar_Click" SkinID="button-save" Text="Salvar" Width="89px" OnClientClick="return confirm('Tem certeza que deseja desativar este Centro Pop?');" />
