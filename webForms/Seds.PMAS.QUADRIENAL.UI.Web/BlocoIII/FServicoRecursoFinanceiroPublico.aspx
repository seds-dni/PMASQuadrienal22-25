<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="True" CodeBehind="FServicoRecursoFinanceiroPublico.aspx.cs" Inherits="Seds.PMAS.QUADRIENAL.UI.Web.BlocoIII.FServicoRecursoFinanceiroPublico" %>
            ...
            <form name="frmUnidadesPublicas">
                <div class="accordion">
                    <div class="frame active">
                        <div class="heading">
                            3.4.a - Serviços e Recursos Financeiros do local de execução
                        </div>
                        <div class="content">
                                                            ...
                                                            <div class="row cells2">
                                                                ...
                                                                <div class="cell">
                                                                    <b>
                                                                        <br />
                                                                        <br />
                                                                        <asp:CheckBox runat="server" ID="chkNaoPossuiTecnicoResponsavel" Text="Não há responsável pelo equipamento" AutoPostBack="true" OnCheckedChanged="chkNaoPossuiTecnicoResponsavel_CheckedChanged" />
                                                                    </b>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                ...
                                                                <div class="row cells2">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="cell">
                                                                            ...
                                                                            <asp:CheckBoxList ID="situacoesEspecificas" runat="server" RepeatColumns="2" />
                                                                        </div>
                                                                    </div>
                                                                                    ...
                                                                                    <asp:ListView ID="lstRecursosAdicionadosExercicio3" OnItemDataBound="lstRecursosAdicionadosExercicio3_ItemDataBound" runat="server" DataKeyNames="Id" OnItemCommand="lstRecursosAdicionadosExercicio3_ItemCommand">
                                                                                        ...
                                                                                        <ItemTemplate>
                                                                                            <tr>
                                                                                                ...
                                                                                                <td align="center"><%#((Decimal)DataBinder.Eval(Container.DataItem, "ValorFonteRecurso")).ToString("N2") %></td>
                                                                                                <td align="center">
                                                                                                    <asp:ImageButton ID="btnExcluirExercicio3" 
                                                                                                        runat="server" 
                                                                                                        CausesValidation="false" 
                                                                                                        CommandName="Excluir"
                                                                                                        Visible='<%#DataBinder.Eval(Container.DataItem, "Liberado")%>' 
