<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FServicoRecursoFinanceiroCREAS.aspx.cs" Inherits="Seds.PMAS.QUADRIENAL.UI.Web.BlocoIII.FServicoRecursoFinanceiroCREAS" %>
            ...
            <form name="frmUnidadesPublicas">
                <div class="accordion">
                    <div class="frame active">
                        <div class="heading">
                            3.8.A - Informações sobre este serviço
                        </div>
                        <div class="content">
                                                    ...
                                                    <div class="frame" id="frame1_1">
                                                        <fieldset class="border-blue">
                                                            ...
                                                            <div class="row cells3">
                                                                ...
                                                                <div class="cell">
                                                                    <b>Usuários:</b><br />
                                                                    <div class="input-control control select full-size">
                                                            ...
                                                            <div class="row cells2" id="tbNaoTipificadoDetalhado" runat="server" visible="false">
                                                                <div class="cell">
                                                            ...
                                                            <div class="row cells2">
                                                                ...
                                                                <div class="cell">
                                                                    <b>
                                                                        <asp:CheckBox runat="server" ID="chkNaoPossuiTecnicoResponsavel" Text="Não há responsável pelo serviço"
                                                                            ...
                                                                            <div class="subframe active">
                                                                                ...
                                                                                <div class="content border-blue">
                                                                                    ...
                                                                                    <div class="row" id="trRendaCidadaBeneficioIdoso" runat="server" visible="false">
                                                                                        <div class="cell">
                                                                                            <b>
                                                                                                <asp:Label ID="lblBenificiarios" runat="server"></asp:Label></b>
                                                                                            <br />
                                                                                    ...
                                                                                    <div class="row">
                                                                                        <div class="cell">
                                                                                            ...
                                                                                            &nbsp;<asp:Button ID="Button1" runat="server" SkinID="button-save" PostBackUrl="~/BlocoIII/CProgramasProjetos.aspx" Text="Voltar" />
                                                                                        </div>
                                                                                    </div>
                                                                                                        ...
                                                                                                        <asp:Repeater ID="rptProgramaTemp" runat="server">
                                                                                                            ...
                                                                                                            <ItemTemplate>
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td >
                                                                                                                        <asp:ImageButton ID="btnExcluir" runat="server"  CausesValidation="false" CommandArgument='<%#DataBinder.Eval(Container.DataItem, "Id") %>' OnClick="btnExcluir_Click"  ImageUrl="~/Styles/Icones/editdelete.png" OnClientClick="return confirm('Deseja realmente desfazer esta associação entre serviço e programa?');" />
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                            </ItemTemplate>
                                                                                                            <FooterTemplate>
                                                                                        ...
                                                                                        <div class="cell">
                                                                                            <asp:ListView ID="lstRecursos" runat="server" OnItemCommand="lstRecursos_ItemCommand">
                                                                                                ...
                                                                                                <ItemTemplate>
                                                                                                    ...
                                                                                                    <asp:ListView ID="lstItems" runat="server" DataSource='<%#Eval("Items") %>' OnItemDataBound="lstItems_ItemDataBound" DataKeyNames="TipoCofinanciamento">
                                                                                                        <LayoutTemplate>
                                                                                                            <tr id="itemPlaceholder" runat="server">
                                                                                                            </tr>
                                                                                                        </LayoutTemplate>
                                                                                                        <ItemTemplate>
                                                                                                            <tr>
                                                                                                                ...
                                                                                                                <%--  <td style="width:0px;"><asp:label ID="lblTipoCofinanciamento" CommandArgument='<%#DataBinder.Eval(Container.DataItem, "TipoCofinanciamento") %>' runat="server" ></asp:label></td>--%>
                                                                                                            </tr>
                                                                                                        </ItemTemplate>
                                                                                                    </asp:ListView>
                                                                                                    </tr>
                                                                                                    ...
                                                                                                    <asp:ListView ID="lstItems" runat="server" DataSource='<%#Eval("Items") %>' OnItemDataBound="lstItems_ItemDataBound">
                                                                                                        ...
                                                                                                        <ItemTemplate>
                                                                                                            <tr>
                                                                                                                ...
                                                                                                                <td class="align-center"><%#String.Format("{0:0,0}",DataBinder.Eval(Container.DataItem, "NumeroUsuarios")) %></td>
                                                                                                                <td class="align-center">
                                                                                                                    <asp:ImageButton ID="btnExcluir" runat="server" CausesValidation="false" CommandArgument='<%#DataBinder.Eval(Container.DataItem, "Id") %>' CommandName="Excluir" ImageUrl="~/Styles/Icones/editdelete.png" OnClientClick="return confirm('Deseja realmente desfazer esta associação entre serviço e programa?');" />
                                                                                                                </td>
                                                                                                            </tr>
                                                                                                        </ItemTemplate>
                                                                                                    </asp:ListView>
                                                    ...
                                                    <div class="frame" id="frame1_4">
                                                        <fieldset class="border-blue">
                                                          ...
                                                          <div class="row">
                                                            ...
                                                            <div class="row">
                                                                <div class="cell">
                                                                    <b class="titulo">Trabalho realizado por este serviço (apontar somente as ações que são de fato realizadas por este serviço)</b>
                                                            ...
                                                            <div class="frames">
                                                                <div class="frame" id="frame1_5_1">
                                                                    <fieldset class="border-blue">
                                                                        ...
                                                                        <div id="trRecursosFinanceirosCREAS" runat="server" visible="true">
                                                                            <fieldset class="border-blue">
                                                                        ...
                                                                        <div class="row">
                                                                            <fieldset class="border-blue">
                                                                                ...
                                                                                <div class="row cells3">
                                                                                    ...
                                                                                    <div class="cell" id="Div11" runat="server">
                                                                                        <b>FEAS - Demandas Parlamentares</b><br />
                                                                                        <div class="input-control text">
