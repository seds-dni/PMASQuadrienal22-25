<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VServicoRecursoFinanceiroPrivado.aspx.cs" Inherits="Seds.PMAS.QUADRIENAL.UI.Web.BlocoIII.VServicoRecursoFinanceiroPrivado" %>
        ...
        <ContentTemplate>
            <div class="accordion" data-role="accordion" data-no-close="true">
                <div class="frame active">
                    <div class="heading">
                        3.14.b - Informações sobre este serviço
                            <span class="mif-organization icon"></span>
                    </div>
                    <div class="content">
                        <div class="formInput" data-text="Serviço da Rede Indireta">
                            <div class="grid">
                                <div class="row">
                                    <div class="cell">
                                ...
                                <div class="row">
                                    <fieldset class="border-blue">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="row">
                                                <div id="trCriancasPensaoMorte2025" class ="cell" runat="server" visible="false">
                                                    <b>O serviço atende crianças aptas para receber pensão por morte regulamentada pela Lei nº 8.213/1991, nos artigos 74 e 79?</b><br />
                                ...
                                <div class="row">
                                    <div id="trRecursosFinanceiros" runat="server" visible="false">
                                        <div class="cell">
                                            <fieldset class="border-blue">
                                                            ...
                                                            <asp:Repeater runat="server" ID="rptFundosAbas">
                                                                <ItemTemplate>
                                                                    <li id="Li1" runat="server"
                                                                        onclick='$("#MainContent_hdnExercicio").val("2022")'>
                                                                        ...
                                                                        <div id="trRecursosFinanceirosPublicos" runat="server" visible="true">
                                                                            <fieldset class="border-blue">
                                                                                ...
                                                                                <div class="row mid-size" id="tdlstRecursosAdicionados" runat="server" visible="true">
                                                                                    <asp:ListView ID="lstRecursosAdicionados" runat="server" DataKeyNames="Id" DataSource='<%# DataBinder.Eval(Container.DataItem, "ServicoRecursoFinanceiroPrivadoFontesRecursosInfo") %>'>
                                                                                        <LayoutTemplate>
                                                                                ...
                                                                                <div class="row" id="recursosPropriaOrganizacao" runat="server">
                                                                                    <fieldset class="border-blue">
                                                                                        <div class="row">
                                                                                            <div class="cell">
                                                                                                ...
                                                                                                <asp:Label runat="server" ID="lblRecursosExclusivosExibicao" Text='<%#((Decimal?)DataBinder.Eval(Container.DataItem, "ValorRecursoExclusivoServico")).Value.ToString("N2") %>'></asp:Label>
                                                                                            </div>
                                                                                        </div>
                                                                                    </fieldset>
                                                                                </div>

                                                                                <div class="row" id="trConvenioEstadualizado" runat="server">
                                                                                    <fieldset class="border-blue">
                                                                                        <legend class="lgnd"><b class="fg-blue">Serviço estadualizado</b></legend>
                                                                                        <div class="row">
                                                                                            <div class="cell">
                                                                                                <b>Este serviço possui convênio firmado com o Estado ?</b><br />
                                                                                                <asp:Label ID="lblPossuiConvenioExibicao" runat="server" Text='<%#((Boolean)(DataBinder.Eval(Container.DataItem, "ConvenioEstadualizado")) ? "Sim": "Não" )%>'></asp:Label>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="row" id="trMotivoConvenioEstadualizado" runat="server" visible='<%#((Boolean)DataBinder.Eval(Container.DataItem, "ConvenioEstadualizado")) %>'>
                                                                                            <div class="cell">
                                                                                                <b>Motivo:</b><br />
                                                                                                <asp:Label ID="Label1" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "MotivoEstadualizadoInfo.Nome") %>'></asp:Label>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="row" id="trValorAnualConvenio" runat="server" visible='<%# ((Boolean)DataBinder.Eval(Container.DataItem, "ServicoEstadualizado")) %>'>
                                                                                            <div class="cell">
                                                                                                <b>Valor anual do convênio:</b><br />
                                                                                                <div class="input-control text">
                                                                                                    <asp:Label ID="txtValorEstadualizado" runat="server" Text='<%#((DataBinder.Eval(Container.DataItem, "ValorEstadualizado") != null) ? (Decimal?)DataBinder.Eval(Container.DataItem, "ValorEstadualizado") : Convert.ToDecimal(0M)).Value.ToString("N2") %>' Style="text-align: right;" />
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </fieldset>
                                ...
                                <div class="row" id="trServicosAssociados" runat="server">
                                    <div class="cell">
                                        <fieldset class="border-blue">
                                            <legend class="lgnd fg-blue"><b class="titulo">Integração com programas, projetos e benefícios:</b></legend>
