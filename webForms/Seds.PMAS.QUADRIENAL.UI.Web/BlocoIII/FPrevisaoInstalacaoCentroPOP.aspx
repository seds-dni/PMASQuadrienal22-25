<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FPrevisaoInstalacaoCentroPOP.aspx.cs" Inherits="Seds.PMAS.QUADRIENAL.UI.Web.BlocoIII.FPrevisaoInstalacaoCentroPOP" %>
            ...
            <table class="ui-widget ui-widget-content ui-corner-all" cellspacing="2" cellpadding="0"
                        ...
                        <table width="100%">
                            <tr>
                                <td>
                                    ...
                                    <b style="font-size: 18px;">21</b> <b>- Previsão de implantação do Centro POP</b> </td>
                                <td align="right"><a id="linkAlteracoesPrevisaoImplantacaoPOP" runat="server" href="#" visible="false">
                ...
                <tr class="bg-alternative">
                    <td align="left" colspan="3">
                        <b>Há previsão de implantação do Centro Pop?</b>
                ...
                <tr id="trDataPrevista" runat="server" visible="false">
                    <td align="left" colspan="3">
                        <b>Informar a(s) data(s) prevista(s) para implantação de Centro Pop em 2017:</b>
                        <br />
                ...
                <tr id="trMotivosNaoInstalacao" runat="server" visible="false">
                    <td align="left" colspan="3">
                        <asp:Label ID="lblMotivosNaoInstalacao" Font-Bold="true" Text="Indique o(s) motivo(s) para que não haja previsão de implantação do Centro Pop:"
                                ...
                                <table class="ui-jqgrid ui-widget ui-widget-content ui-corner-all" cellspacing="0"
                                    ...
                                    <thead>
                                        <tr class="ui-jqgrid-labels">
                                            ...
                                            <th class="ui-state-default ui-th-column ui-th-ltr" width="400">Previsão de implantação do Centro Pop
                                            </th>
