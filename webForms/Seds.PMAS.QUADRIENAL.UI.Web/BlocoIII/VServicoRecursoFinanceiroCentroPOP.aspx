<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VServicoRecursoFinanceiroCentroPOP.aspx.cs" Inherits="Seds.PMAS.QUADRIENAL.UI.Web.BlocoIII.VServicoRecursoFinanceiroCentroPOP" %>
            ...
            <form name="frmUnidadesPublicas">
                <div class="accordion" data-role="accordion" data-no-close="true">
                    <div class="frame active">
                        <div class="heading">
                            3.10.B - Informações sobre este serviço
                                ...
                                <div class="grid">
                                                            ...
                                                            <asp:Repeater runat="server" ID="rptFundosAbas">
                                                                <ItemTemplate>
                                                                    <li id="Li1" runat="server"
                                                                        onclick='$("#MainContent_hdnExercicio").val("2018")'>
                                                                            ...
                                                                            <div id="trRecursosFinanceirosPublicos" runat="server" visible="true">
                                                                                <fieldset class="border-blue">
                                                                                    ...
                                                                                    <div class="row mid-size" id="tdlstRecursosAdicionados" runat="server" visible="true">
                                                                                        <asp:ListView ID="lstRecursosAdicionados" runat="server" DataKeyNames="Id" DataSource='<%# DataBinder.Eval(Container.DataItem, "ServicoRecursoFinanceiroCentroPOPFontesRecursosInfo") %>'>
                                                                                            <LayoutTemplate>
                                    ...
                                    <div class="row" id="trServicosAssociados" runat="server">
                                        <fieldset class="border-blue">
                                            ...
                                            <fieldset id="fldTransferenciaRenda" class="border-blue" runat="server">
