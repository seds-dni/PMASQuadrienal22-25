...
{
    public partial class VLocalExecucaoPrivado : System.Web.UI.Page
    {
        ...
        void load(ProxyRedeProtecaoSocial proxy)
        {
            ...
            lblTecnicoResponsavel.Text = local.PossuiTecnicoResponsavel ? local.TecnicoResponsavel : "Não possui técnico responsável";
            ...
            if (local.Desativado)
            {
                ...
                if (local.IdMotivoDesativacao.HasValue)
                {
                    ...
                    if (local.IdMotivoDesativacao.Value != 1)
                    {
                        ...
                        if (local.IdMotivoDesativacao.Value == 2)
                        {
                            lblDescEncerramentoServico.Text = "Data do encerramento do termo de convênio, parceria ou fomento:";
                            lblDescDetalhamento.Text = "Detalhamento sobre o motivo do encerramento termo de convênio, parceria ou fomento:";
                            ...
                            lblDescEncerramentoServico.Text = "Data do encerramento das atividades da organização:";
                            lblDescDetalhamento.Text = "Detalhamento sobre o motivo do encerramento das atividades da organização:";
                        }
                    }
                    else
                    {
