<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FServicoRecursoFinanceiroCentroPOP.aspx.cs" Inherits="Seds.PMAS.QUADRIENAL.UI.Web.BlocoIII.FServicoRecursoFinanceiroCentroPOP" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel ID="pnlCadastro" runat="server">
            ...
            <form name="frmUnidadesPublicas">
                <div class="accordion">
                    <div class="frame active">
                        <div class="heading">
                            3.10.A - Informações sobre este serviço
                        </div>
                        <div class="content">
        ...
        <Triggers>
            <asp:AsyncPostBackTrigger ControlID="ddlTipoServicoNaoTipificado" EventName="SelectedIndexChanged" />
            <asp:AsyncPostBackTrigger ControlID="ddlTipoServico" EventName="SelectedIndexChanged" />
            <asp:AsyncPostBackTrigger ControlID="ddlPublicoAlvo" EventName="SelectedIndexChanged" />
            <asp:AsyncPostBackTrigger ControlID="ddlAbrangencia" EventName="SelectedIndexChanged" />
        </Triggers>
    </asp:UpdatePanel>
</asp:Content>
