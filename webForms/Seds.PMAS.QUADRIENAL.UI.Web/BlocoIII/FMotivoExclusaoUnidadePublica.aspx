<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FMotivoExclusaoUnidadePublica.aspx.cs" Inherits="Seds.PMAS.QUADRIENAL.UI.Web.BlocoIII.FMotivoExclusaoUnidadePublica" %>
    ...
    <form name="frmPrefeitura">
        <div class="accordion" data-role="accordion">
            <div class="frame active">
                <div class="heading">
                    Desativação de Unidade Pública
                </div>
                <div class="content">
                    <div class="formInput">
                        <div class="grid">
                                ...
                                <fieldset class="border-blue">
                                    ...
                                    <div class="row">
                                        <div class="cell">
                                            ...
                                            <div class="row">
                                                <div class="cell">
                                                    <b>A desativação desta unidade é devida a:</b><br />
                                            ...
                                            <div class="row" id="trDataEncerramento" runat="server" visible="false">
                                                <div class="cell">
                                                    <b>
                                                       Data do encerramento das atividades da unidade pública&nbsp;</b><uc4:data id="txtDataEncerramento" runat="server" />
                                                </div>
                                            </div>
                                            <div class="row" id="trDetalhamento" runat="server" visible="false">
                                                <div class="cell">
                                                    <div class="input-control text big-input full-size" data-role="input">
                                                        <b>
                                                            Detalhamento das atividades da unidade pública:</b><br />
                                            ...
                                            <div class="row">
                                                <div class="cell" align="center">
                                                    <asp:Button ID="btnSalvar" runat="server" OnClick="btnSalvar_Click" SkinID="button-save" Text="Salvar" Width="89px" OnClientClick="return confirm('Tem certeza que deseja desativar esta unidade?');" />
