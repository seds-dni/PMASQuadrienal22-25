<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VServicoRecursoFinanceiroCREAS.aspx.cs" Inherits="Seds.PMAS.QUADRIENAL.UI.Web.BlocoIII.VServicoRecursoFinanceiroCREAS" %>
            ...
            <form name="frmUnidadesPublicas">
                <div class="accordion" data-role="accordion" data-no-close="true">
                    <div class="frame active">
                        <div class="heading">
                            3.8.b - Informações sobre este serviço
                                                                            ...
                                                                            <div id="trRecursosFinanceirosPublicos" runat="server" visible="true">
                                                                                <fieldset class="border-blue">
                                                                                    ...
                                                                                    <div class="row mid-size" id="tdlstRecursosAdicionados" runat="server" visible="true">
                                                                                        <asp:ListView ID="lstRecursosAdicionados" runat="server" DataKeyNames="Id" DataSource='<%# DataBinder.Eval(Container.DataItem, "ServicoRecursoFinanceiroCREASFontesRecursosInfo") %>'>
                                                                                            <LayoutTemplate>
