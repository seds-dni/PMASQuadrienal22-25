...
{
    public partial class RAuxilioReclusaoPensaoMorte : System.Web.UI.Page
    {
        ...
        void carregarPagina()
        {
            Master.Titulo = "Relat&#243;rio descritivo 41 - Auxilio Reclusão Pensão por Morte";
        ...
        void carregarDados()
        {
            ...
            filtro.Exercicio = Convert.ToInt32(Session["RELATORIO_EXERCICIO_ARPM"]);

            Master.mostrarFiltros(filtro, ETipoRelatorio.Descritivo);
            var items = new List<RAuxilioReclusaoPensaoMorteInfo>();
            using (var proxy = new ProxyRelatorios())
            {
                items = proxy.Service.GetAuxilioReclusaoPensaoMorte(filtro);
            }
            lstAuxilioReclusaoPensaoMorte.DataSource = items;
            lstAuxilioReclusaoPensaoMorte.DataBind();
        }
        ...
        void gerarExcel()
        {
            ...
            var tb = ((HtmlTable)lstAuxilioReclusaoPensaoMorte.FindControl("tbReport"));
            tb.CellPadding = 1;
            tb.CellSpacing = 1;
            tb.Border = 1;
            ...
            Response.Clear();
            Response.AddHeader("content-disposition", "attachment;filename=RelatorioDescritivo41.xls");
            Response.Charset = "";
        ...
        protected void lstAuxilioReclusaoPensaoMorte_ItemDataBound(object sender, ListViewItemEventArgs e)
        {
