...
{
    public partial class RInformacoesCadastraisOrgaoGestor : System.Web.UI.Page
    {
        ...
        void carregarPagina()
        {
            Master.Titulo = "Relat&#243;rio cadastral 2 - Cadastro dos &#211;rg&#227;os gestores municipais da Assist&#234;ncia Social";
           Master.MainWidthRelatorio = Master.WidthRelatorio = "2200px";
        ...
        void carregarDados()
        {
            ...
            var items = new List<InformacoesCadastraisOrgaoGestorInfo>();
            using(var proxy = new ProxyRelatorios())
            {
                items = proxy.Service.GetInformacoesCadastraisOrgaoGestor(filtro).ToList();
            }
        ...
        void gerarExcel()
        {
            ...
            Response.Clear();
            Response.AddHeader("content-disposition", "attachment;filename=RelatorioCadastral2.xls");
            Response.Charset = "";
