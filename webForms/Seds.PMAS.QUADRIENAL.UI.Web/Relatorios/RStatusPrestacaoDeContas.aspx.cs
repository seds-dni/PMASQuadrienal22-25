...
{
    public partial class RStatusPrestacaoDeContas : System.Web.UI.Page
    {
        ...
        void carregarPagina()
        {
            Master.Titulo = "Relat&#243;rio descritivo 38 - Status da Presta&#231;&#227;o de Contas";
        ...
        void carregarDados()
        {
            ...
            var items = new List<RStatusPrestacaoDeContasInfo>();
            using (var proxy = new ProxyRelatorios())
            {
                items = proxy.Service.GetStatusPrestacaoDeContas(filtro);
            }
            lstStatusPrestacaoDeContas.DataSource = items;
            lstStatusPrestacaoDeContas.DataBind();
        ...
        void gerarExcel()
        {
            ...
            var tb = ((HtmlTable)lstStatusPrestacaoDeContas.FindControl("tbReport"));
            tb.CellPadding = 1;
            tb.CellSpacing = 1;
            tb.Border = 1;
            ...
            Response.Clear();
            Response.AddHeader("content-disposition", "attachment;filename=RelatorioDescritivo38.xls");
            Response.Charset = "";
        ...
        protected void lstStatusPrestacaoDeContas_ItemDataBound(object sender, ListViewItemEventArgs e)
        {
