...
{
    public partial class RProgramasMunicipaisTransferenciaRenda : System.Web.UI.Page
    {
        ...
        void carregarPagina()
        {
            Master.Titulo = "Relat&#243;rio descritivo 18 - Informa&#231;&#245;es sobre programas municipais de transfer&#234;ncia de renda";
        ...
        void carregarDados()
        {
            ...
            var items = new List<ProgramasMunicipaisTransferenciaRendaInfo>();
            using (var proxy = new ProxyRelatorios())
            {
                items = proxy.Service.GetProgramasMunicipaisTransferenciaRenda(filtro).ToList();
            }
