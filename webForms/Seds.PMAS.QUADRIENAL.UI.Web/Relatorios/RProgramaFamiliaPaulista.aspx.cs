...
{
    public partial class RProgramaFamiliaPaulista : System.Web.UI.Page
    {
        ...
        void carregarPagina()
        {
            Master.Titulo = "Relat&#243;rio descritivo 30 - Programa Faml&#237;ia Paulista";
            Master.WidthRelatorio = "3250";
        ...
        void carregarDados()
        {
            ...
            var items = new List<InformacoesProgramaFamiliaPaulistaInfo>();
            using (var proxy = new ProxyRelatorios())
            {
                items = proxy.Service.GetInformacoesProgramaFamiliaPaulista(filtro).ToList();
            }
