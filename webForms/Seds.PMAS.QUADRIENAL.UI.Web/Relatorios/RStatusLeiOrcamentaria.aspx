<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Relatorios/Relatorio.Master" CodeBehind="RStatusLeiOrcamentaria.aspx.cs" Inherits="Seds.PMAS.QUADRIENAL.UI.Web.Relatorios.RStatusLeiOrcamentaria" %>

<%@ MasterType VirtualPath="~/Relatorios/Relatorio.Master" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="conteudo" runat="server">
    <asp:ListView ID="lstStatusLeiOrcamentaria" runat="server" OnItemDataBound="lstStatusLeiOrcamentaria_ItemDataBound" >
       <LayoutTemplate>
        ...
        <ItemTemplate>
            <tr>
                ...
                <td>
                    <%#DataBinder.Eval(Container.DataItem, "Exercicio2025") %>
                </td>
            </tr>
        </ItemTemplate>
