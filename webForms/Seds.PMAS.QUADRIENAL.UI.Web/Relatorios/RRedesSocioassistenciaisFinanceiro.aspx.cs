...
{
    public partial class RRedesSocioassistenciaisFinanceiro : System.Web.UI.Page
    {
        ...
        void carregarPagina()
        {
            Master.Titulo = "Relat&#243;rio descritivo 8.2 - Rede de servi&#231;os socioassistenciais (Financeiro)";
        ...
        {            
            ...
            {
                items = proxy.Service.GetRedeServicoSocioassistencial(filtro).ToList();
            }
        ...
        void gerarExcel()
        {
            ...
            Response.Clear();
            Response.AddHeader("content-disposition", "attachment;filename=RelatorioDescritivo8_2.xls");
            Response.Charset = "";
