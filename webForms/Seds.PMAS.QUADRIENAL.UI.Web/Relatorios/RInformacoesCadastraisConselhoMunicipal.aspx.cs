...
{
    public partial class RInformacoesCadastraisConselhoMunicipal : System.Web.UI.Page
    {
        ...
        void carregarPagina()
        {
            Master.Titulo = "Relat&#243;rio cadastral 3 - Cadastro dos conselhos";
        ...
        void carregarDados()
        {
            var filtro = new RelatorioFiltroInfo() { TipoConselho = Session["RELATORIO_TIPO_CONSELHO_ID"] as int? };
            ...
            var items = new List<InformacoesCadastraisConselhoMunicipalInfo>();
            using(var proxy = new ProxyRelatorios())
            {
                items = proxy.Service.GetInformacoesCadastraisConselhoMunicipal(filtro).ToList();
            }
        ...
        void gerarExcel()
        {
            ...
            Response.Clear();
            Response.AddHeader("content-disposition", "attachment;filename=RelatorioCadastral3.xls");
            Response.Charset = "";
