(function (inicio, $, undefined)
{
    seds.inicio = seds.inicio || {};
    seds.inicio.ConsultarPMAS = {};
    seds.inicio.FBloqueioQuadroFinanceiro = {};

    seds.inicio.ConsultarPMAS.toggleBuscador = function () {
        $("#pnlBuscador").show();
    }

    seds.inicio.ConsultarPMAS.displayBuscador = function () {
        
        $("#MainContent_tdSituacao").show();
        seds.inicio.ConsultarPMAS.toggleBuscador();
    }

    seds.inicio.ConsultarPMAS.hideBuscador = function () {
        $("#MainContent_tdSituacao").hide();
        seds.inicio.ConsultarPMAS.toggleBuscador();
    }

    seds.inicio.FBloqueioQuadroFinanceiro.RecursosBloquear = function (exercicio) {
        if (confirm("Irá BLOQUEAR TODOS os recursos de TODOS OS MUNICIPIOS para o exercício de " + exercicio + ", deseja continuar?")) {
            $("#MainContent_hdnExercicioParaBloquearDesbloquear").val(exercicio);
            $("#MainContent_hdnEhdesbloqueio").val(false);
    ...
    seds.inicio.FBloqueioQuadroFinanceiro.RecursosDesbloquear = function (exercicio) {
        if (confirm("Irá DESBLOQUEAR TODOS os recursos de TODOS OS MUNICIPIOS para o exercício de " + exercicio + ", deseja continuar?")) {
            $("#MainContent_hdnExercicioParaBloquearDesbloquear").val(exercicio);
            $("#MainContent_hdnEhdesbloqueio").val(true);
            return true;
        }
        else {
            return false;
    ...
    seds.inicio.FBloqueioQuadroFinanceiro.PCBloquear = function (exercicio) {
        console.log("Bloque:" + exercicio)
        if (confirm("Irá BLOQUEAR TODOS os QUADROS EXECUÇÃO FINANCEIRA de TODOS OS MUNICIPIOS para o exercício de " + exercicio + ", deseja continuar?")) {
            $("#MainContent_hdnPCExercicio").val(exercicio);
            $("#MainContent_hdnPCDesbloqueado").val(false);
            return true;
        }
        else {
            return false;
    ...
    seds.inicio.FBloqueioQuadroFinanceiro.PCDesbloquear = function (exercicio) {
        console.log("Desbl:" + exercicio)
        if (confirm("Irá DESBLOQUEAR TODOS os QUADROS EXECUÇÃO FINANCEIRA de TODOS OS MUNICIPIOS para o exercício de "+ exercicio + ", deseja continuar?")) {
            $("#MainContent_hdnPCExercicio").val(exercicio);
            $("#MainContent_hdnPCDesbloqueado").val(true);
            return true;
        }
        else {
            return false;
    ...
    ///
    seds.inicio.FBloqueioQuadroFinanceiro.EFBloquear = function (exercicio) {
        console.log("Bloque:" + exercicio)
        if (confirm("Irá BLOQUEAR TODOS os QUADROS EXECUÇÃO FINANCEIRA de TODOS OS MUNICIPIOS para o exercício de " + String(parseInt(exercicio)) + ", deseja continuar?")) {
            $("#MainContent_hdnEFExercicio").val(exercicio);
            $("#MainContent_hdnEFDebloqueado").val(false);
            return true;
        }
        else {
            return false;
    ...
    seds.inicio.FBloqueioQuadroFinanceiro.EFDesbloquear = function (exercicio) {
        console.log("Desbl:" + exercicio)
        if (confirm("Irá DESBLOQUEAR TODOS os QUADROS EXECUÇÃO FINANCEIRA de TODOS OS MUNICIPIOS para o exercício de " + String(parseInt(exercicio)) + ", deseja continuar?")) {
            $("#MainContent_hdnEFExercicio").val(exercicio);
            $("#MainContent_hdnEFDebloqueado").val(true);
            return true;
        }
        else {
            return false;
    ...
    ///LEI ORCAMENTARIA
    ///
    seds.inicio.FBloqueioQuadroFinanceiro.LOBloquear = function (exercicio) {
        if (confirm("Irá BLOQUEAR TODOS os QUADROS LEI ORCAMENTARIA de TODOS OS MUNICIPIOS para o exercício de " + exercicio + ", deseja continuar?")) {
            $("#MainContent_hdnLOExercicio").val(exercicio);
            $("#MainContent_hdnEhdesbloqueio").val(false);
            return true;
        }
        else {
    ...
    seds.inicio.FBloqueioQuadroFinanceiro.LODesbloquear = function (exercicio) {
        if (confirm("Irá DESBLOQUEAR TODOS os QUADROS LEI ORCAMENTARIA de TODOS OS MUNICIPIOS para o exercício de " + exercicio + ", deseja continuar?")) {
            $("#MainContent_hdnLOExercicio").val(exercicio);
            $("#MainContent_hdnLODebloqueado").val(true);
            return true;
        }
        else {
            return false;
