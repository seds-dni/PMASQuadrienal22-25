...
{
    [DataContract]
    public class ServicoRecursoFinanceiroFundosCentroPOPInfo
    {
        [DataMember]
        public Int32 Id { get; set; }
        [DataMember]
        public Int32 ServicoRecursoFinanceiroCentroPOPInfoId { get; set; }
        [DataMember]
        ...
        public ServicoRecursoFinanceiroCentroPOPInfo ServicoRecursoFinanceiroCentroPOPInfo { get; set; }

        public List<ServicoRecursoFinanceiroCentroPOPFonteRecursoInfo> ServicoRecursoFinanceiroCentroPOPFontesRecursosInfo { get; set; }
    }
}
