...
{
    [DataContract]
    public class ServicoRecursoFinanceiroFundosPublicoInfo
    {
        [DataMember]
        public Int32 Id { get; set; }
        [DataMember]
        public Int32 ServicoRecursoFinanceiroPublicoInfoId { get; set; }
        [DataMember]
        ...
        public ServicoRecursoFinanceiroPublicoInfo ServicoRecursoFinanceiroPublicoInfo { get; set; }
        
        public List<ServicoRecursoFinanceiroPublicoFonteRecursoInfo> ServicoRecursoFinanceiroPublicoFontesRecursosInfo { get; set; }        
    }
}
