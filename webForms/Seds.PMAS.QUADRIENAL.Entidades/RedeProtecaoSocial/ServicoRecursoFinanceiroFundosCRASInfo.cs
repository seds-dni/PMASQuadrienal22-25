...
{
    [DataContract]
    public class ServicoRecursoFinanceiroFundosCRASInfo
    {
        [DataMember]
        public Int32 Id { get; set; }
        [DataMember]
        public Int32 ServicoRecursoFinanceiroCRASInfoId { get; set; }
        [DataMember]
        ...
        public ServicoRecursoFinanceiroCRASInfo ServicoRecursoFinanceiroCRASInfo { get; set; }

        public List<ServicoRecursoFinanceiroCRASFonteRecursoInfo> ServicoRecursoFinanceiroCRASFontesRecursosInfo { get; set; }
    }
}
