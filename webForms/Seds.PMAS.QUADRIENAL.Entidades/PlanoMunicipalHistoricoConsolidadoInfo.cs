...
namespace Seds.PMAS.QUADRIENAL.Entidades
{
    ...
    [DataContract]
    public class PlanoMunicipalHistoricoConsolidadoInfo
    {
        [DataMember]
        public Int32 Id { get; set; }
        
        [DataMember]
        public Int32 IdPlanoMunicipalHistorico { get; set; }
        ...
        #region ReprogramacaoDemandasParlamentares
        ...
        [DataMember]
        public Decimal? ValorProgramaProjetoReprogramadoDemandas { get; set; }
        ...
        [DataMember]
        public PlanoMunicipalHistoricoInfo PlanoMunicipalHistorico { get; set; }
        #endregion
